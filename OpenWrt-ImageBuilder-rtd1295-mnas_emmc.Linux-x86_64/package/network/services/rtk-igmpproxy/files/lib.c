...
**
**  $Id: lib.c,v 1.1.1.1 2007-08-06 10:04:43 root Exp $	
**
...
*/
{
	struct in_addr InAdr_tmp;
	InAdr_tmp.s_addr = ntohl(InAdr.s_addr);
	sprintf( St, "%u.%u.%u.%u", 
		 ((uint8 *)&InAdr_tmp.s_addr)[ 0 ],
		 ((uint8 *)&InAdr_tmp.s_addr)[ 1 ],
		 ((uint8 *)&InAdr_tmp.s_addr)[ 2 ],
		 ((uint8 *)&InAdr_tmp.s_addr)[ 3 ] );

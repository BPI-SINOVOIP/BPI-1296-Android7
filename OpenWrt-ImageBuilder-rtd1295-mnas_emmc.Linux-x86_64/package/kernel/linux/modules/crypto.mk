...
ifeq ($(strip $(call CompareKernelPatchVer,$(KERNEL_PATCHVER),ge,3.18.21)),1)
crc32c_mod_suffix=_generic
endif
...
define KernelPackage/crypto-crc32c
  ...
  FILES:= $(LINUX_DIR)/crypto/crc32c$(crc32c_mod_suffix).ko 
  AUTOLOAD:=$(call AutoLoad,04,crc32c$(crc32c_mod_suffix),1)
  $(call AddDepends/crypto)
endef

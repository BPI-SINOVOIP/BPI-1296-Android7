...
#if defined(CONFIG_RTD_1295_HWNAT)
#ifndef WRITE_MEM32
#define WRITE_MEM32(reg, val) iowrite32(val, (void __iomem *)reg)
#endif

#ifndef WRITE_MEM16
#define WRITE_MEM16(reg, val) iowrite16(val, (void __iomem *)reg)
#endif

#ifndef WRITE_MEM8
#define WRITE_MEM8(reg,val) iowrite8(val, (void __iomem *)reg)
#endif

#ifndef READ_MEM32
#define READ_MEM32(reg) ioread32((void __iomem *)reg)
#endif

#ifndef READ_MEM16
#define READ_MEM16(reg) ioread16((void __iomem *)reg)
#endif

#ifndef READ_MEM8
#define READ_MEM8(reg) ioread8((void __iomem *)reg)
#endif
...
#if defined(CONFIG_RTD_1295_HWNAT)
#define RTL_R32(addr)				ioread32((void __iomem *)addr)
#define RTL_W32(addr, l)			iowrite32(l, (void __iomem *)addr)
#define RTL_R8(addr)				ioread8((void __iomem *)addr)
#define RTL_W8(addr, l)				iowrite8(l, (void __iomem *)addr)
#else //defined(CONFIG_RTD_1295_HWNAT)
...
#if defined(CONFIG_RTD_1295_HWNAT)
enum rtl_hwnat_mmio_idx {
	HWNAT_SWTBL_BASE_IDX = 0,
	HWNAT_MIB_BASE_IDX,
	HWNAT_GBL_CTRL_BASE_IDX,
	HWNAT_EXT_MAC_CTRL_BASE_IDX,
	HWNAT_GD_STA_BASE_IDX,
	HWNAT_GMII_TM_BASE_IDX,		/* 5 */
	HWNAT_CPU_IFACE_BASE_IDX,
	HWNAT_SERDES_BASE_IDX,
	HWNAT_NAT_WRP_BASE_IDX,
	HWNAT_SERDES_ANA_BASE_IDX,
	HWNAT_MAX_IDX			/* 10 */
};

/* physical address from 0x98060000 to 0x981CFFFF */
enum rtl_hwnat_mmio_offset {
	HWNAT_SWTBL_OFFSET	= 0,		/* all tables in SWCORE */
	HWNAT_CPUIR_OFFSET	= 0x160000,	/* CPU Interface Register */
	HWNAT_MIB_OFFSET	= 0x161000,	/* MIM Counters */
	HWNAT_GPCR_OFFSET	= 0x164000,	/* Global Port Control Register */
	HWNAT_EXT_MACCR_OFFSET	= 0x165000,	/* Extend MAC Control Register */
	HWNAT_DDR1_OFFSET	= 0x166100,	/* Descriptor Diagnostic Register (group 1) */
	HWNAT_DDR2_OFFSET	= 0x166200,	/* Descriptor Diagnostic Register (group 2) */
	HWNAT_GMII_TM_OFFSET	= 0x166400,	/* MAC GMII i/f Test Mode TX Register */
	HWNAT_SERDES_OFFSET	= 0x168000,	/* SERDES register , address 16bits */
	HWNAT_NAT_WRP_OFFSET	= 0x169000,	/* NAT wrapper registers */
	HWNAT_SERDES_WRP_OFFSET	= 0x169800,	/* SERDES wrapper registers */
	HWNAT_SERDES_ANA_OFFSET	= 0x16A000,	/* SERDES ANA page register , address 16bits */
};

extern void __iomem *rtl_hwnat_mmio;
extern unsigned int rtl_hwnat_base;

#define CPU_IFACE_BASE				((uintptr_t) rtl_hwnat_mmio + HWNAT_CPUIR_OFFSET)
#define REAL_SWCORE_BASE			CPU_IFACE_BASE
//#define REAL_SYSTEM_BASE			0x981B0000
#define REAL_HSA_BASE				((uintptr_t) rtl_hwnat_mmio + HWNAT_DDR2_OFFSET)
#define REAL_HSB_BASE				(REAL_HSA_BASE + 0x80)
//#define REAL_SWTBL_BASE			((uintptr_t) rtl_hwnat_mmio + HWNAT_SWTBL_OFFSET)
#define SW_SWTBL_BASE				((uintptr_t) rtl_hwnat_mmio + HWNAT_SWTBL_OFFSET)
#define HW_SWTBL_BASE				(rtl_hwnat_base + HWNAT_SWTBL_OFFSET)
//#define HW_SWTBL_BASE				0x1B000000
#else //defined(CONFIG_RTD_1295_HWNAT)
...
/* redefine CPU_IFACE_BASE as ((unsigned int) rtl_hwnat_mmio + HWNAT_CPUIR_OFFSET) */
#if !defined(CONFIG_RTD_1295_HWNAT)
...
#if defined(CONFIG_RTD_1295_HWNAT)
#define CPUIMCR					(0x080 + CPU_IFACE_BASE)	/* CPU Interrupt Migration Control Register */
#define CPUIMTTR0				(0x084 + CPU_IFACE_BASE)	/* CPU Interrupt Migration Timeout Threshold Register 0 */
#define CPUIMTTR1				(0x088 + CPU_IFACE_BASE)	/* CPU Interrupt Migration Timeout Threshold Register 1 */
#define CPUIMTTR2				(0x08c + CPU_IFACE_BASE)	/* CPU Interrupt Migration Timeout Threshold Register 2 */
#define CPUIMTTR3				(0x090 + CPU_IFACE_BASE)	/* CPU Interrupt Migration Timeout Threshold Register 3 */
#define CPUIMPNTR0				(0x094 + CPU_IFACE_BASE)	/* CPU Interrupt Migration Packet Numbers Threshold Register 0 */
#define CPUIMPNTR1				(0x098 + CPU_IFACE_BASE)	/* CPU Interrupt Migration Packet Numbers Threshold Register 1 */
#define CPUIMPNTR2				(0x09c + CPU_IFACE_BASE)	/* CPU Interrupt Migration Packet Numbers Threshold Register 2 */
#endif //defined(CONFIG_RTD_1295_HWNAT)
...
#if defined(CONFIG_RTD_1295_HWNAT)
/* OWN bit of word5 */
#define DESC_OWNED2_BIT				(1 << 15)
#define DESC_RISC_OWNED2			(0 << 15)
#define DESC_SWCORE_OWNED2			(1 << 15)
#endif //defined(CONFIG_RTD_1295_HWNAT)
...
#if defined(CONFIG_RTD_1295_HWNAT)
#define BISTTSDR0				(0x18+SWMISC_BASE)	/* BIST Test Status Diagnostic Register 0 */
#define BISTTSDR1				(0x1C+SWMISC_BASE)	/* BIST Test Status Diagnostic Register 1 */
#define BISTTSDR2				(0x20+SWMISC_BASE)	/* BIST Test Status Diagnostic Register 2 */
#else //defined(CONFIG_RTD_1295_HWNAT)
...
#if defined(CONFIG_RTD_1295_HWNAT)
/* 0x981C_8000 */
#define HWNAT_SERDES_BASE			((uintptr_t) rtl_hwnat_mmio + HWNAT_SERDES_OFFSET)
#define HWNAT_SERDES_SDS_REG00			(0x000 + HWNAT_SERDES_BASE)
#define HWNAT_SERDES_SDS_REG01			(0x004 + HWNAT_SERDES_BASE)
#define HWNAT_SERDES_SDS_REG02			(0x008 + HWNAT_SERDES_BASE)
#define HWNAT_SERDES_SDS_REG03			(0x00C + HWNAT_SERDES_BASE)
#define HWNAT_SERDES_SDS_REG04			(0x010 + HWNAT_SERDES_BASE)

/* 0x981C_9000 */
#define NAT_WRP_BASE				((uintptr_t) rtl_hwnat_mmio + HWNAT_NAT_WRP_OFFSET)
#define NAT_WRP_DMY_A				(0x100 + NAT_WRP_BASE)	/* dummy reg A */
#define NAT_WRP_DMY_B				(0x104 + NAT_WRP_BASE)	/* dummy reg B */
#define NAT_WRP_DEBUG				(0x108 + NAT_WRP_BASE)	/* debug */
#define NAT_WRP_SERDES				(0x10C + NAT_WRP_BASE)	/* SerDes */

#define NAT_WRP_SERDES_sata_phy_mdio_en_shift	(12)
#define NAT_WRP_SERDES_serdes_clk_en_shift	(9)
#define NAT_WRP_SERDES_sdsif_clk_en_shift	(8)
#define NAT_WRP_SERDES_sds_idx_shift		(0)

/* 0x981C_9800 */
#define SERDES_WRP_BASE				((uintptr_t) rtl_hwnat_mmio + HWNAT_SERDES_WRP_OFFSET)
#define SERDES_WRP_SDS_MODE			(0x000 + SERDES_WRP_BASE)
#define SERDES_WRP_SDS_MISC			(0x004 + SERDES_WRP_BASE)
#define SERDES_WRP_SDS_LPI			(0x008 + SERDES_WRP_BASE)
#define SERDES_WRP_SDS_LINK			(0x00C + SERDES_WRP_BASE)

#define SERDES_WRP_SDS_MISC_sds_link_ok_sum_shift	(13)
#define SERDES_WRP_SDS_MISC_sds_link_ok_shift		(12)

#define SERDES_WRP_SDS_LINK_partner_ablity_shift	(12)
#define SERDES_WRP_SDS_LINK_partner_fib_linkok		(1 << 4)

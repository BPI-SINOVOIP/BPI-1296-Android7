...
extern int rtk_enter_loopback_mode(struct ata_port *ap);
#endif
...
#ifdef CONFIG_AHCI_RTK
static ssize_t ahci_host_loopback_mode(struct device *dev,
...
#ifdef CONFIG_AHCI_RTK
static DEVICE_ATTR(loopback_mode, S_IRUGO, ahci_host_loopback_mode, NULL);
#endif

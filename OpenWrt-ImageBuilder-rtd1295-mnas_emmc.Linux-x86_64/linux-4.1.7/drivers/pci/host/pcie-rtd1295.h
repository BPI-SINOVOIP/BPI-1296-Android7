...
#ifdef PCI_DBG_EN
#define PCI_DBG(fmt, args...) printk("[RTD129x PCIE] DBG, " fmt, ## args)
#else
...
#define PCI_INFO(fmt, args...) printk("[RTD129x PCIE] INFO," fmt, ## args)
#define PCI_WARNING(fmt, args...) printk("[RTD129x PCIE] WARNING," fmt, ## args)

#ifdef PCI_REG_DBG_EN
#define PCI_REG_DBG(fmt, args...) printk("[RTD129x PCIE] REG DBG," fmt, ## args)
#else
#define PCI_REG_DBG(fmt, args...) \
do { \
} while(0)
#endif

#ifdef PCI_CFG_DBG_EN
#define PCI_CFG_DBG(fmt, args...) printk("[RTD129x PCIE] CFG DBG," fmt, ## args)
#else
#define PCI_CFG_DBG(fmt, args...) do {} while(0)
#endif

#define PCI_CFG_WARNING(fmt, args...) printk(KERN_ALERT "[RTD129x PCIE] CFG WARNING," fmt, ## args)

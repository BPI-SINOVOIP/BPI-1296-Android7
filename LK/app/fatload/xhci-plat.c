...
static int dwc3_core_init(struct ctrl_data dwc3)
{
	...
	//u32 hwparams0 = dwc3_readl(dwc3, DWC3_GHWPARAMS0);
	u32 hwparams1 = dwc3_readl(dwc3, DWC3_GHWPARAMS1);
	//u32 hwparams2 = dwc3_readl(dwc3, DWC3_GHWPARAMS2);
	//u32 hwparams3 = dwc3_readl(dwc3, DWC3_GHWPARAMS3);
	//u32 hwparams4 = dwc3_readl(dwc3, DWC3_GHWPARAMS4);
	//u32 hwparams5 = dwc3_readl(dwc3, DWC3_GHWPARAMS5);
	//u32 hwparams6 = dwc3_readl(dwc3, DWC3_GHWPARAMS6);
	//u32 hwparams7 = dwc3_readl(dwc3, DWC3_GHWPARAMS7);
	//u32 hwparams8 = dwc3_readl(dwc3, DWC3_GHWPARAMS8);

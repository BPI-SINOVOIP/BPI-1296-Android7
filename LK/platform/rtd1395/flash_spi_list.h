...
#define GD25Q80C_8Mbit              0xc84014
...
static s_device_type s_device[] = 
{
    ...
    {MX_25L6405D_64Mbit,           0, 1, 0, 1, 1, 0x00800000, "MX 64Mbit"},
    ...
    {GD25Q80C_8Mbit,               0, 1, 1, 1, 1, 0x00100000, "GD25Q80C_08Mbit"} ,
    ...
    {IS25LQ080B_8Mbit,             0, 1, 1, 1, 1, 0x00100000, "IS25LQ080B_8Mbit"} ,
    {IS25LQ016B_16Mbit,            0, 1, 1, 1, 1, 0x00200000, "IS25LQ016B_16Mbit"} ,
    {IS25LQ032B_32Mbit,            0, 1, 1, 1, 1, 0x00400000, "IS25LQ032B_32Mbit"} ,
    {IS25LP128_128Mbit,            0, 1, 1, 1, 1, 0x01000000, "IS25LP128_128Mbit"} ,

    {BY25D20_2Mbit,                0, 1, 1, 1, 1, 0x00040000, "BY25D20_2Mbit"} ,
    {BY25D40_4Mbit,                0, 1, 1, 1, 1, 0x00080000, "BY25D40_4Mbit"} ,
    {BY25D16_16Mbit,               0, 1, 1, 1, 1, 0x00200000, "BY25D20_16Mbit"} ,
    {BY25Q32BS_32Mbit,             0, 1, 1, 1, 1, 0x00400000, "BY25Q32BS_32Mbit"} ,
    {BY25Q64AS_64Mbit,             0, 1, 1, 1, 1, 0x00800000, "BY25Q64AS_64Mbit"} ,
    {BY25Q128AS_128Mbit,           0, 1, 1, 1, 1, 0x01000000, "BY25Q128AS_128Mbit"} ,
} ; 

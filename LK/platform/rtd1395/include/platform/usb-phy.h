...
#define PORT2_USB2_PHY_CTRL_ID 1
#define PORT2_USB2_PHY_WRITE_ADDR 0x98031284 // GUSB2PHYACC
#define PORT2_USB2_PHY_VSTATUS_ADDR 0x98013C14 // VSTATUS_reg
#define PORT2_USB2_PHY_SWITCH_ADDR 0x98013C70 //USB2_PHY_reg
...
#define USB3_PHY_NUM 0 // port0-port1

#define PORT0_USB3_PHY_ENABLE 0
#define PORT0_USB3_PHY_CTRL_ID 0 // host/device id
#define PORT0_USB3_PHY_WRITE_ADDR -1

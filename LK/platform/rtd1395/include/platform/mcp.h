...
/* When market ID is burned in rtd1395 borad, it can't
   use the MCP_TEE of MCP driver.
   In the rtd1395, MCP driver always use the MCP_REE.   
 */
//For SWC
/* MCP General Registers */
...
//#define CP_DESCRIPTOR_ADDR		(0x1a000000)	/* CP descriptor address */
//#define CP_DSCPT_POOL_BASE_ADDR		(0x1b000000)	/* CP descriptor pool base address */
//#define CP_OUT_BASE_ADDR		(0x1c000000)	/* CP descriptor pool base address */

...
private:
    void                endianSwap(void *addr, unsigned int byte_size);
    void                endianSwapMemoryCopy(unsigned char* src, unsigned char* des, unsigned long len);
    unsigned int        sendInbandCmd(void *cmd_endian_swapped, unsigned int cmd_size);

...
private:
    ...
    void VDecCheckDecodeComplete(bool bForce=false);
#if RVSD_RM_ENABLE
...
#endif
    int VDecScanPLockBufferClearRtkFlag(int *pNumLock=NULL, int *pNumQpend=NULL, int *pNumClrDispFlag=NULL, int *pNumSeqChangeVoLock=NULL, bool bFreeIonFb=false);
    ...
    void ReleasePpuByPpuIdx(int ppu_index);

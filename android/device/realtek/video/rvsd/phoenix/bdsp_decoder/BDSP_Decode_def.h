...
#define FIXED_DHCFAE3178    // extra buffer for RLE.
...
#define BDSP_MAX_LINEAR_BUF_SIZE (BDSP_TOTAL_OBJECT_BUFFER_SIZE - BDSP_MAX_OBJECT_BUFFER_SIZE)

/* size of bitstream wrap-around copy buffer */
#define BDSP_LINEAR_BS_BUFFER_SIZE    (BDSP_MAX_LINEAR_BUF_SIZE >> 1) // (BDSP_MAX_LINEAR_BUF_SIZE / BDSP_MAX_NUM_OBJECTS_PER_PAGE)

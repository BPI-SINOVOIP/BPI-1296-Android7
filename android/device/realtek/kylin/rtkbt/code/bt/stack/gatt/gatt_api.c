...
/*******************************************************************************
**
** Function         GATT_RemoveLinkFlag
**
** Description      This function revome the GATT link flag for this registered
**                  application.
**
** Parameters       conn_id: connection identifier.
**
** Returns          GATT_SUCCESS if removed.
**
*******************************************************************************/
tGATT_STATUS GATT_RemoveLinkFlag (UINT16 conn_id)
{
    tGATT_STATUS    ret = GATT_ILLEGAL_PARAMETER;
    tGATT_TCB       *p_tcb=NULL;
    tGATT_IF        gatt_if=GATT_GET_GATT_IF(conn_id);
    ...
    GATT_TRACE_API ("GATT_RemoveLinkFlag conn_id=%d ", conn_id);

...
#define BLUETOOTH_RTK_BQB_PATCH_MPS     (0x00000001)
#define BLUETOOTH_RTK_BQB_PATCH_HOGP    (0x00000002)
#define BLUETOOTH_RTK_BQB_PATCH_SCPP    (0x00000004)
const static char * BLUETOOTH_RTK_BQB_PATCH_ITEMSTR[] = {
    "MPS",
    "HOGP"
};
#endif

...
LOCAL_MODULE := bluetoothtbd_rtk
LOCAL_REQUIRED_MODULES = bluetooth.default
LOCAL_STATIC_LIBRARIES += libbtcore_rtk
else
...
LOCAL_SHARED_LIBRARIES += \
	...
	libutils
ifeq ($(BOARD_HAVE_BLUETOOTH_RTK), true)
LOCAL_INIT_RC := bluetoothtbd_rtk.rc
else
...
ifeq ($(BOARD_HAVE_BLUETOOTH_RTK), true)
LOCAL_MODULE := bluetoothtbd-host_test_rtk
else
...
LOCAL_MODULE_TAGS := debug tests
ifeq ($(BOARD_HAVE_BLUETOOTH_RTK), true)
LOCAL_MODULE := bluetoothtbd_test_rtk
else
...
ifeq ($(BOARD_HAVE_BLUETOOTH_RTK), true)
LOCAL_MODULE := libbluetooth-client_rtk
else
...
LOCAL_MODULE_TAGS := optional
ifeq ($(BOARD_HAVE_BLUETOOTH_RTK), true)
LOCAL_MODULE := bluetooth-cli_rtk
LOCAL_STATIC_LIBRARIES += libbluetooth-client_rtk
else
...
LOCAL_MODULE_TAGS := optional
ifeq ($(BOARD_HAVE_BLUETOOTH_RTK), true)
LOCAL_MODULE := bt-example-hr-server_rtk
LOCAL_STATIC_LIBRARIES += libbluetooth-client_rtk
else

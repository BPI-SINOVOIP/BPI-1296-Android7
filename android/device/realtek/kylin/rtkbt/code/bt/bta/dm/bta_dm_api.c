...
void BTA_DmAddBleDeviceExtraInfo(BD_ADDR bd_addr, DEV_CLASS dev_class, BD_NAME bd_name)
{
    ...
    APPL_TRACE_DEBUG("BTA_DmAddBleDeviceExtraInfo: dev_class: %d : %d : %d  name :%s", dev_class[0],dev_class[1],dev_class[2], bd_name);

    if ((p_msg = (tBTA_DM_API_ADD_BLE_DEVICE_EXTRA_INFO *) osi_calloc(sizeof(tBTA_DM_API_ADD_BLE_DEVICE_EXTRA_INFO))) != NULL)
    {
        ...
        APPL_TRACE_API ("BTA_DmAddBleDeviceExtraInfo getbuf fail ");
#endif
}

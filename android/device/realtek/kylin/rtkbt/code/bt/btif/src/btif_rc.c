...
static const btrc_interface_t bt_rc_interface = {
    .size = sizeof(bt_rc_interface),
    .init = init,
    .get_play_status_rsp = get_play_status_rsp,
    .list_player_app_attr_rsp = NULL, /* list_player_app_attr_rsp */
    .list_player_app_value_rsp = NULL, /* list_player_app_value_rsp */
    .get_player_app_value_rsp = NULL, /* get_player_app_value_rsp */
    .get_player_app_attr_text_rsp = NULL, /* get_player_app_attr_text_rsp */
    .get_player_app_value_text_rsp = NULL, /* get_player_app_value_text_rsp */
    .get_element_attr_rsp = get_element_attr_rsp,
    .set_player_app_value_rsp = NULL, /* set_player_app_value_rsp */
...
static const btrc_ctrl_interface_t bt_rc_ctrl_interface = {
    .size = sizeof(bt_rc_ctrl_interface),
    .init = init_ctrl,
    .send_pass_through_cmd = send_passthrough_cmd,
    .send_group_navigation_cmd = send_groupnavigation_cmd,
    .set_player_app_setting_cmd = change_player_app_setting,
    .set_volume_rsp = set_volume_rsp,
    .register_abs_vol_rsp = volume_change_notification_rsp,
    .cleanup = cleanup_ctrl,
};
#else
static const btrc_ctrl_interface_t bt_rc_ctrl_interface = {

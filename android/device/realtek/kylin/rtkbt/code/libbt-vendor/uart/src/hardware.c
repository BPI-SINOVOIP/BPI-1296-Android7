...
#define EXTRA_CONFIG_FILE "/data/misc/bluetooth/rtk_btconfig.txt"
...
CFG_START:
            case HW_CFG_START:
            {
                ...
                ALOGI("Check total_len(0x%08x) max_patch_size(0x%08x)", hw_cfg_cb.total_len, hw_cfg_cb.max_patch_size);

PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/system/usr/keylayout/Vendor_005d_Product_0002.kl:system/usr/keylayout/Vendor_005d_Product_0002.kl \
    $(LOCAL_PATH)/system/etc/bluetooth/rtkbt_plugin_autopair_stack.conf:system/etc/bluetooth/rtkbt_plugin_autopair_stack.conf \
    $(LOCAL_PATH)/system/etc/bluetooth/rtkbt_plugin_vr_bee_hidraw.conf:system/etc/bluetooth/rtkbt_plugin_vr_bee_hidraw.conf \

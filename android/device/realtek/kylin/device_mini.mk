...
ENABLE_RTK_HDMI_SERVICE := false
USE_SETTINGS_SERVICE := false
ENABLE_MEDIA_QUERY := true
ENABLE_RTK_HDMIRX_SERVICE := false
USE_RTK_GPIO := false
# For DRM code flow
...
USE_JPU := NO
USE_RTK_PPPOE := NO
ENABLE_RT_WIFIDISPLAY := NO
# for DTV
ENABLE_1195_DTV_FLOW := NO
...
PRODUCT_PROPERTY_OVERRIDES += ro.config.enablehdcp=false #FIXME
else

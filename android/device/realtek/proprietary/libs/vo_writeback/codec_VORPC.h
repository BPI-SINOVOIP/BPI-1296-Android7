...
#define CODEC_CAST_32ADDR(fmt) (((unsigned int) (long)(fmt)) & -1U)
...
VORPCGlobal *codec_vo_init(unsigned int fbCount);
HRESULT codec_vo_checkAvailable(VORPCGlobal *pVORPC, int writebackType);
...
unsigned int codec_vo_getpLockAddrWithIdx(VORPCGlobal *pVORPC, int idx ,unsigned char **pLockVirAddr);
...
HRESULT codec_vo_AddWriteBackBuffers_10bit(VORPCGlobal *pVORPC,int i, unsigned long phyAddress, unsigned char * virtAddress, int IsUseAllocBuff);
HRESULT codec_vo_ClearWriteBackBuffers(VORPCGlobal *pVORPC, unsigned long phyAddress, unsigned char * virtAddress);
HRESULT codec_vo_LockWriteBackBuffers(VORPCGlobal *pVORPC, unsigned long phyAddress, unsigned char * virtAddress);

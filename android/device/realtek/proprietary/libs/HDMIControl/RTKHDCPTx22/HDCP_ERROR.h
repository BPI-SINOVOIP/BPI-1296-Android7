...
typedef enum{
	...
	ENUM(HDCP_ERR_SRM_ERROR),
    ENUM(HDCP_ERR_RESET_HDMI),
    ENUM(HDCP_ERR_POLLING_RXSTATUS_I2C_ERROR),
	ENUM(HDCP_ERR_HDMI_PLUG_OUT),
} HDCP_ERR;
...
static const char *hdcp_err_str[]={
	...
	STR(HDCP_ERR_SRM_ERROR),
    STR(HDCP_ERR_RESET_HDMI),
    STR(HDCP_ERR_POLLING_RXSTATUS_I2C_ERROR),
	STR(HDCP_ERR_HDMI_PLUG_OUT),
};

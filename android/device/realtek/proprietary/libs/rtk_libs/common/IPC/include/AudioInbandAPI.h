...
typedef enum
{
    ...
    AUDIO_LPCM_ALSA_S24_TYPE= 3        // ALSA signed 24 bits
} AUDIO_ENDIANTYPE;
...
} AUDIO_PRIVATE_MS12_WAVE_PCM_INFO;
...
*/
	...
	AUDIO_INBAND_CMD_PRIVATE_DEMUX_INIT = 3, // AUDIO_DEMUX_BUFFER_INFO
	AUDIO_INBAND_CMD_PRIVATE_NONPCM_CFG = 4, // AUDIO_INFO_SPDIF_NONPCM_CFG
	AUDIO_INBAND_CMD_PRIVATE_SPIDIF_BS  = 5, // AUDIO_INFO_SPDIF_BS_INFO
	AUDIO_INBAND_CMD_PRIVATE_TRANSENC_BUFFER_INIT = 6, // AUDIO_TRANSENC_BUFFER_INIT
    AUDIO_INBAND_CMD_PRIVATE_TRANSENC_NONPCM_CFG = 7,   // AUDIO_TRANSENC_NONPCM_CFG
	AUDIO_INBAND_CMD_PRIVATE_TRANSENC_BS_INFO  = 8, // AUDIO_TRANSENC_BS_INFO

...
#define RPC_TOAGENT_DISCONNECT(x,y,z)
...
#define RPC_TOAGENT_DISCONNECT_SVC
...
HRESULT* 			RPC_AIN_Switch_Focus(AUDIO_IN_SOURCE* ai_focus_in, RPC_STRUCT* clnt, HRESULT *retval);
...
HRESULT*            RPC_TOAGENT_PP_PTS_MIXER_Config(AUDIO_RPC_PTS_MIXER_CONFIG* rpc_pts_mixer, RPC_STRUCT* clnt, HRESULT *retval)
...
#define RPC_TOAGENT_AIO_PRIVATEINFO(x,y,z)		AUDIO_RPC_ToAgent_AIO_PrivateInfo_0(x,y)
...
#define RPC_TOAGENT_AIO_PRIVATEINFO_SVC		AUDIO_RPC_ToAgent_AIO_PrivateInfo_0_svc

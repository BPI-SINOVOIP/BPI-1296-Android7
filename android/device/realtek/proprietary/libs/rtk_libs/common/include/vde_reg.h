...
// Firmware Header Generate Date : 2010/1/11
***************************************************************/
...
typedef struct 
{
unsigned int     blk_h:7;
unsigned int     blk_w:4;
unsigned int     blk_y:11;
...
#define VC_DMA_BLK_blk_h_shift                                                       (25)
#define VC_DMA_BLK_blk_h_mask                                                        (0xFE000000)
#define VC_DMA_BLK_blk_h(data)                                                       (0xFE000000&((data)<<25))
#define VC_DMA_BLK_blk_h_src(data)                                                   ((0xFE000000&(data))>>25)
#define VC_DMA_BLK_get_blk_h(data)                                                   ((0xFE000000&(data))>>25)
#define VC_DMA_BLK_blk_w_shift                                                       (21)
#define VC_DMA_BLK_blk_w_mask                                                        (0x01E00000)
#define VC_DMA_BLK_blk_w(data)                                                       (0x01E00000&((data)<<21))
#define VC_DMA_BLK_blk_w_src(data)                                                   ((0x01E00000&(data))>>21)
#define VC_DMA_BLK_get_blk_w(data)                                                   ((0x01E00000&(data))>>21)
#define VC_DMA_BLK_blk_y_shift                                                       (10)
#define VC_DMA_BLK_blk_y_mask                                                        (0x001FFC00)
#define VC_DMA_BLK_blk_y(data)                                                       (0x001FFC00&((data)<<10))
#define VC_DMA_BLK_blk_y_src(data)                                                   ((0x001FFC00&(data))>>10)
#define VC_DMA_BLK_get_blk_y(data)                                                   ((0x001FFC00&(data))>>10)

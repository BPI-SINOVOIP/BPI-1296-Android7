...
// Firmware Header Generate Date : 2009/11/26
***************************************************************/
...
#define TP_PID_DATA2_key_mask                                                        (0x00000780)
#define TP_PID_DATA2_key(data)                                                       (0x00000780&((data)<<7))
#define TP_PID_DATA2_key_src(data)                                                   ((0x00000780&(data))>>7)
#define TP_PID_DATA2_get_key(data)                                                   ((0x00000780&(data))>>7)
...
#define TP_THRESHOLD_threshold_mask                                                  (0x0FFFFFFF)
#define TP_THRESHOLD_threshold(data)                                                 (0x0FFFFFFF&((data)<<0))
#define TP_THRESHOLD_threshold_src(data)                                             ((0x0FFFFFFF&(data))>>0)
#define TP_THRESHOLD_get_threshold(data)                                             ((0x0FFFFFFF&(data))>>0)
...
#define TP_FULLNESS_fullness_mask                                                    (0x0FFFFFFF)
#define TP_FULLNESS_fullness(data)                                                   (0x0FFFFFFF&((data)<<0))
#define TP_FULLNESS_fullness_src(data)                                               ((0x0FFFFFFF&(data))>>0)
#define TP_FULLNESS_get_fullness(data)                                               ((0x0FFFFFFF&(data))>>0)
...
#define TP_RING_LIMIT_ring_limit_mask                                                (0x7FFFFFF8)
#define TP_RING_LIMIT_ring_limit(data)                                               (0x7FFFFFF8&((data)<<3))
#define TP_RING_LIMIT_ring_limit_src(data)                                           ((0x7FFFFFF8&(data))>>3)
#define TP_RING_LIMIT_get_ring_limit(data)                                           ((0x7FFFFFF8&(data))>>3)
...
#define TP_RING_BASE_ring_base_mask                                                  (0x7FFFFFF8)
#define TP_RING_BASE_ring_base(data)                                                 (0x7FFFFFF8&((data)<<3))
#define TP_RING_BASE_ring_base_src(data)                                             ((0x7FFFFFF8&(data))>>3)
#define TP_RING_BASE_get_ring_base(data)                                             ((0x7FFFFFF8&(data))>>3)
...
#define TP_RING_RP_ring_rp_mask                                                      (0x7FFFFFFF)
#define TP_RING_RP_ring_rp(data)                                                     (0x7FFFFFFF&((data)<<0))
#define TP_RING_RP_ring_rp_src(data)                                                 ((0x7FFFFFFF&(data))>>0)
#define TP_RING_RP_get_ring_rp(data)                                                 ((0x7FFFFFFF&(data))>>0)
...
#define TP_RING_WP_ring_wp_mask                                                      (0x7FFFFFFF)
#define TP_RING_WP_ring_wp(data)                                                     (0x7FFFFFFF&((data)<<0))
#define TP_RING_WP_ring_wp_src(data)                                                 ((0x7FFFFFFF&(data))>>0)
#define TP_RING_WP_get_ring_wp(data)                                                 ((0x7FFFFFFF&(data))>>0)
...
#define TP_M2M_RING_LIMIT_ring_limit_mask                                            (0x7FFFFFF8)
#define TP_M2M_RING_LIMIT_ring_limit(data)                                           (0x7FFFFFF8&((data)<<3))
#define TP_M2M_RING_LIMIT_ring_limit_src(data)                                       ((0x7FFFFFF8&(data))>>3)
#define TP_M2M_RING_LIMIT_get_ring_limit(data)                                       ((0x7FFFFFF8&(data))>>3)
...
#define TP_M2M_RING_BASE_ring_base_mask                                              (0x7FFFFFF8)
#define TP_M2M_RING_BASE_ring_base(data)                                             (0x7FFFFFF8&((data)<<3))
#define TP_M2M_RING_BASE_ring_base_src(data)                                         ((0x7FFFFFF8&(data))>>3)
#define TP_M2M_RING_BASE_get_ring_base(data)                                         ((0x7FFFFFF8&(data))>>3)
...
#define TP_M2M_RING_RP_ring_rp_mask                                                  (0x7FFFFFFF)
#define TP_M2M_RING_RP_ring_rp(data)                                                 (0x7FFFFFFF&((data)<<0))
#define TP_M2M_RING_RP_ring_rp_src(data)                                             ((0x7FFFFFFF&(data))>>0)
#define TP_M2M_RING_RP_get_ring_rp(data)                                             ((0x7FFFFFFF&(data))>>0)
...
#define TP_M2M_RING_WP_ring_wp_mask                                                  (0x7FFFFFFF)
#define TP_M2M_RING_WP_ring_wp(data)                                                 (0x7FFFFFFF&((data)<<0))
#define TP_M2M_RING_WP_ring_wp_src(data)                                             ((0x7FFFFFFF&(data))>>0)
#define TP_M2M_RING_WP_get_ring_wp(data)                                             ((0x7FFFFFFF&(data))>>0)
...
#define TP_SYNC_POS_sync_pos_mask                                                    (0x1FFFFFFF)
#define TP_SYNC_POS_sync_pos(data)                                                   (0x1FFFFFFF&((data)<<0))
#define TP_SYNC_POS_sync_pos_src(data)                                               ((0x1FFFFFFF&(data))>>0)
#define TP_SYNC_POS_get_sync_pos(data)                                               ((0x1FFFFFFF&(data))>>0)

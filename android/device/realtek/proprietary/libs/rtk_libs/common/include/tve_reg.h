...
// Firmware Header Generate Date : 2010/5/6
***************************************************************/
...
#define TVE_DAC_MISC_dac_value_shift                                                 (0)
#define TVE_DAC_MISC_dac_value_mask                                                  (0x00000FFF)
#define TVE_DAC_MISC_dac_value(data)                                                 (0x00000FFF&((data)<<0))
#define TVE_DAC_MISC_dac_value_src(data)                                             ((0x00000FFF&(data))>>0)
#define TVE_DAC_MISC_get_dac_value(data)                                             ((0x00000FFF&(data))>>0)

...
// Firmware Header Generate Date : 2010/3/23
***************************************************************/
...
#define SE_SRC_COLOR_src_color_mask                                                  (0x00FFFFFF)
#define SE_SRC_COLOR_src_color(data)                                                 (0x00FFFFFF&((data)<<0))
#define SE_SRC_COLOR_src_color_src(data)                                             ((0x00FFFFFF&(data))>>0)
#define SE_SRC_COLOR_get_src_color(data)                                             ((0x00FFFFFF&(data))>>0)

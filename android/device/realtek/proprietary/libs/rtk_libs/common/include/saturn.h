...
#define TEST_PASS_TPCPU 0x80303000
#define TEST_FAIL_TPCPU 0x80303020

#define TEST_PASS_VCPU1 0x80403000
#define TEST_FAIL_VCPU1 0x80403020

#define TEST_PASS_VCPU2 0x80503000
#define TEST_FAIL_VCPU2 0x80503020
...
#define USER_PROG_START_TPCPU 0x80304000
#define USER_PROG_START_VCPU1 0x80404000
#define USER_PROG_START_VCPU2 0x80504000
...
#define HW_INTVEC_ADDR0_KCPU  0x80300300
#define HW_INTVEC_ADDR1_KCPU  0x80300304
#define HW_INTVEC_ADDR2_KCPU  0x80300308
#define HW_INTVEC_ADDR3_KCPU  0x8030030c
#define HW_INTVEC_ADDR4_KCPU  0x80300310
#define HW_INTVEC_ADDR5_KCPU  0x80300314
#define HW_INTVEC_ADDR6_KCPU  0x80300318
#define HW_INTVEC_ADDR7_KCPU  0x8030031c
...
#define WAIT_BE(addr,mask,value) \
	asm(" nop; nop; nop; nop; ori $0,0x8898;"); \
        while( ((*((unsigned int*) addr))&mask)<value );

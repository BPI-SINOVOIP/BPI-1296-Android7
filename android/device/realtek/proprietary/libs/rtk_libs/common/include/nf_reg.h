...
// Firmware Header Generate Date : 2010/3/16
***************************************************************/
...
#define NF_RSECC_NUM_ecc_num_mask                                                    (0x0000001F)
#define NF_RSECC_NUM_ecc_num(data)                                                   (0x0000001F&((data)<<0))
#define NF_RSECC_NUM_ecc_num_src(data)                                               ((0x0000001F&(data))>>0)
#define NF_RSECC_NUM_get_ecc_num(data)                                               ((0x0000001F&(data))>>0)
...
#define NF_MAX_ECC_NUM_max_ecc_num_mask                                              (0x0000001F)
#define NF_MAX_ECC_NUM_max_ecc_num(data)                                             (0x0000001F&((data)<<0))
#define NF_MAX_ECC_NUM_max_ecc_num_src(data)                                         ((0x0000001F&(data))>>0)
#define NF_MAX_ECC_NUM_get_max_ecc_num(data)                                         ((0x0000001F&(data))>>0)

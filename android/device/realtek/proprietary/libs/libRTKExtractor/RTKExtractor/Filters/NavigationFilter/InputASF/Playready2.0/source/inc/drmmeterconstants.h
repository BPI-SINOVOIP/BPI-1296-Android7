...
extern const DRM_EXPORT_VAR DRM_ANSI_CONST_STRING g_dastrMeterDataKeyNamePath;

extern const DRM_EXPORT_VAR DRM_ANSI_CONST_STRING g_dastrMeterDataKeyNameValue;

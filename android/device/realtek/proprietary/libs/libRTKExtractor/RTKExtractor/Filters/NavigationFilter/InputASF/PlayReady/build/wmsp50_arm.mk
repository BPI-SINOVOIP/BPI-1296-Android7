...
#*
#* Description:
#*    Defines options specific to wmsp50_arm required for compiling/linking
#*    DRM PK source code
#*
...
_DRM_OBJ_TARGETS=$(_DRM_OBJ_TARGETS:PLACEHOLDER_OBJ_PATH=objchk\wmsp50_arm\)
_DRM_OBJ_DIR=objchk\wmsp50_arm
_DRM_BIN_DIR=objchk\wmsp50_arm
_DRM_DROP_DIR=bind\wmsp50_arm
#-------------------------------
!elseif "$(DRM_BUILD_TYPE)" == "FREE"
_DRM_OBJ_TARGETS=$(_DRM_OBJ_TARGETS:PLACEHOLDER_OBJ_PATH=objfre\wmsp50_arm\)
_DRM_OBJ_DIR=objfre\wmsp50_arm
_DRM_BIN_DIR=objfre\wmsp50_arm
_DRM_DROP_DIR=bin\wmsp50_arm
#-------------------------------
!elseif "$(DRM_BUILD_TYPE)" == "PERF"
_DRM_OBJ_TARGETS=$(_DRM_OBJ_TARGETS:PLACEHOLDER_OBJ_PATH=objperf\wmsp50_arm\)
_DRM_OBJ_DIR=objperf\wmsp50_arm
_DRM_BIN_DIR=objperf\wmsp50_arm
_DRM_DROP_DIR=binp\wmsp50_arm
!endif
#-------------------------------
...
# #and if they ensure that there exists lib\wmsp50_arm\foo.lib for platform
# the library the include are automatically platform specific without
# any ugly #ifdef in sources file.
#---------------------------------------------------
LINKLIBS=$(LINKLIBS:*=wmsp50_arm)
TARGETLIBS=$(TARGETLIBS:*=wmsp50_arm)

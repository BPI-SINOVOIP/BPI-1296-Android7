...
typedef struct 
{
    ...
    */
    ...
    int             block_failure;
    int             sample_failure;
    int             real_samples_this_frame;
    int             fail_samples_this_frame;
    /* -------------------------------------------------------------------------
...
#define SEARCH_DIF          1
#define PARSE_HEADER        2
#define PARSE_VAUX          3
#define PARSE_SUBCODE       4
#define PARSE_AUDIO         5
#define PARSE_VIDEO         6
#define RESET_DV            7
#define DROP_DATA           8
//----------------------------------------------------------------------//
...
#define _DVDM_PREFIX_       "[DV_DM] "
#define _WARNING_PREFIX_    "WARNING : "
#define _FATAL_PREFIX_      "FATAL : "

#define _DVDM_MSG_          _DVDM_PREFIX_
#define _DVDM_WARNING_      _DVDM_PREFIX_ _WARNING_PREFIX_
#define _DVDM_FATAL_        _DVDM_PREFIX_ _FATAL_PREFIX_

#ifdef DBG_MSG_EN  
  #define DV_MSG_PRINT  printf      // Maskable Printf
#else     
...
#ifdef DBG_DROPFRAME_EN
  #define DBG_DROPFRAME_PRINT DV_MSG_PRINT
#else
  #define DBG_DROPFRAME_PRINT (void)
#endif

...
DRM_API DRM_RESULT DRM_CALL DRM_XMR_SetDefaults_AuxKey(
    __in_ecount( 1 ) const  DRM_VOID  *f_pvObject );
    
DRM_API DRM_RESULT DRM_CALL DRM_XMR_SetDefaults_UplinkX(
    __in_ecount( 1 ) const  DRM_VOID  *f_pvObject );

DRM_API DRM_RESULT DRM_CALL DRM_XMR_SetDefaults_RemovalDate(
    __in_ecount( 1 )  const   DRM_VOID    *f_pvObject );

DRM_API DRM_RESULT DRM_CALL DRM_XMR_Serialize_RemovalDate(
    __in_ecount( 1 )  const      DRM_VOID    *f_pvObject,
    __inout_bcount( f_cbBuffer ) DRM_BYTE    *f_pbBuffer,
    __in                         DRM_DWORD    f_cbBuffer,
    __inout_ecount( 1 )          DRM_DWORD   *f_piBuffer );

DRM_API DRM_RESULT DRM_CALL DRM_XMR_Serialize_AuxKey(
    __in_ecount( 1 )  const      DRM_VOID    *f_pvObject,
    __inout_bcount( f_cbBuffer ) DRM_BYTE    *f_pbBuffer,
    __in                         DRM_DWORD    f_cbBuffer,
    __inout_ecount( 1 )          DRM_DWORD   *f_piBuffer );

DRM_API DRM_RESULT DRM_CALL DRM_XMR_Serialize_UplinkX(
    __in_ecount( 1 )  const      DRM_VOID    *f_pvObject,
    __inout_bcount( f_cbBuffer ) DRM_BYTE    *f_pbBuffer,
    __in                         DRM_DWORD    f_cbBuffer,
    __inout_ecount( 1 )          DRM_DWORD   *f_piBuffer );

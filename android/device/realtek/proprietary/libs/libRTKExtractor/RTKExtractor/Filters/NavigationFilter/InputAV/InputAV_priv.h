...
#define CMD_ERROR_CONCEAL_LEVEL	    (1L << 16)



#define AV_BUFSIZE                  (V_BUFSIZE + A_BUFSIZE)
#define V_BUFSIZE                   (63*1024) // 63K bytes
#define A_BUFSIZE                   (1*1024) // 1K bytes
...
#define av_warning(fmt, args...)    printf("[InputAV] Warning," fmt, ## args)        
#define av_info(fmt, args...)       printf("[InputAV] Info," fmt, ## args)        
#define av_dbg(fmt, args...)        printf("[InputAV] Dbg," fmt, ## args)    

...
#*        and
#*    _DRM_TARGET_DIRS: This is of the form:
#*        FOO BAR{TARGET.PLAT, TARGET.ARCH, TARGET.PLAT_ARCH}
#*
#* Outputs:
#*    _DRM_TARGET_DIRS: This should be of the form:
...
#             Dir{TARGET.SKIP,TARGET.SKIP_ARCH}
#---------------------------------------------------
_DRM_DIRS_TARGETS=$(_DRM_DIRS_TARGETS:TARGET.WMSP50=TARGET.WMSP50)
_DRM_DIRS_TARGETS=$(_DRM_DIRS_TARGETS:TARGET.WmSp50=TARGET.WMSP50)
_DRM_DIRS_TARGETS=$(_DRM_DIRS_TARGETS:TARGET.Wmsp50=TARGET.WMSP50)
_DRM_DIRS_TARGETS=$(_DRM_DIRS_TARGETS:TARGET.wmsp50=TARGET.WMSP50)

!if "$(DRM_BUILD_PLATFORM)" == "WMSP50"
_DRM_DIRS_TARGETS=$(_DRM_DIRS_TARGETS:TARGET.WMSP50=TARGET.BUILD)
!else
_DRM_DIRS_TARGETS=$(_DRM_DIRS_TARGETS:TARGET.WMSP50=TARGET.SKIP)
!endif

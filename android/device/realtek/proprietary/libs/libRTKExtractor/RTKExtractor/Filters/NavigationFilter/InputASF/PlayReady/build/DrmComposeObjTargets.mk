...
#
# Include the list of object files built by build.exe from the sources file.
# Run build to generate the list first, if it doesn't exist.
#
#------------------------------------------------------------------------------
!if "$(_DRM_BUILD_TOOL)" == "NTBUILD" && !exist($(_DRM_OBJ_PATH)_objects.mac)
!    if [-build -O]
!    endif
!endif
...
#------------------------------------------------------------------------------
# If _objects.mac file does not exist, we will set OBJPATH ourselves
#------------------------------------------------------------------------------

#-------------------------------
!if exist($(_DRM_OBJ_PATH)_objects.mac) && "$(_DRM_BUILD_TOOL)" == "NTBUILD"
!   include $(_DRM_OBJ_PATH)_objects.mac
_DRM_OBJ_PATH_PREFIX=$(OBJ_PATH)
_DRM_BIN_PATH_PREFIX=$(OBJ_PATH)
#-------------------------------
!else
_DRM_OBJ_PATH_PREFIX=$(MAKEDIR)
_DRM_BIN_PATH_PREFIX=$(MAKEDIR)
!endif
#-------------------------------

...
//
EXTERN_C const ASF_GUID ASF_HEADER_OBJECT;
...
//
EXTERN_C const ASF_GUID ASF_DATA_OBJECT;

//
// ASF Simple Index Object == {33000890-E5B1-11CF-89F4-00A0C90349CB}
//
EXTERN_C const ASF_GUID ASF_SIMPLE_INDEX_OBJECT;

//
// ASF Index Object == {D6E229D3-35DA-11D1-9034-00A0C90349BE}
//
EXTERN_C const ASF_GUID ASF_INDEX_OBJECT;
...
//
EXTERN_C const ASF_GUID ASF_FILE_PROPERITES_OBJECT;
...
//
EXTERN_C const ASF_GUID ASF_STREAM_PROPERITES_OBJECT;
...
//
EXTERN_C const ASF_GUID ASF_EXTENDED_STREAM_PROPERTIES_OBJECT;

//
// ASF Language List Object == {7C4346A9-EFE0-4BFC-B229-393EDE415C85}
//
EXTERN_C const ASF_GUID ASF_LANGUAGE_LIST_OBJECT;

//
// ASF Metadata Object == {C5F8CBEA-5BAF-4877-8467-AA8C44FA4CCA}
//
EXTERN_C const ASF_GUID ASF_METADATA_OBJECT;

//
// ASF Index Parameters Object == {D6E229DF-35DA-11D1-9034-00A0C90349BE}
//
EXTERN_C const ASF_GUID ASF_INDEX_PARAMETERS_OBJECT;
...
EXTERN_C const ASF_GUID ASF_AUDIO_MEDIA;

//
// ASF Video Media == {BC19EFC0-5B4D-11CF-A8FD-00805F5C442B}
//
EXTERN_C const ASF_GUID ASF_VIDEO_MEDIA;

//
// ASF Video Media == {3AFB65E2-47EF-40F2-AC2C-70A90D71D343}
//
EXTERN_C const ASF_GUID ASF_BINARY_MEDIA;
...
//
EXTERN_C const ASF_GUID ASF_DRM_GUID;
...
//
EXTERN_C const ASF_GUID ASF_EXTENDED_DRM_GUID;

//for pyv
EXTERN_C const ASF_GUID ASF_PROTECTION_SYSTEM_IDENTIFIER_OBJECT;
EXTERN_C const ASF_GUID ASF_PAYLOAD_EXTENSION_ENCRYPTION_SAMPLEID;

//
// ASF Video Media == {3AFB65E2-47EF-40F2-AC2C-70A90D71D343}
//
EXTERN_C const ASF_GUID ASF_MEDIASUBTYPE_DOLBY_AC3;

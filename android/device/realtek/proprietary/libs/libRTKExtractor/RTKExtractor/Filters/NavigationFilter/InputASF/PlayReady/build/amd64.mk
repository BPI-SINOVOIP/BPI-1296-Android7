...
# --------------------------------------------------------------------------
# On WINPC free/perf builds, use non-DRM CRT option for best option coverage
# --------------------------------------------------------------------------
#
#!if "$(DRM_BUILD_TYPE)" != "CHECKED"
...
# Define it everywhere per above.
_DRM_C_DEFINES = $(_DRM_C_DEFINES) NO_DRM_CRT

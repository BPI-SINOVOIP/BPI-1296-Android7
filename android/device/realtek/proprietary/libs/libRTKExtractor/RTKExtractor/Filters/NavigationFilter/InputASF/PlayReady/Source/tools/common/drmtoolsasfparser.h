...
*****************************/
DRM_RESULT DRM_CALL DRMTOOLS_OpenASFContext(
    IN     OEM_FILEHDL            f_hFile,
    IN OUT DRM_TOOLS_ASF_CONTEXT *f_poAsfContext,
    __out_bcount( f_cbDRMHeaderData )
           DRM_BYTE               f_rgbDRMHeaderData[__CB_DECL( DRM_MAX_PLAYREADYOBJSIZE )],
    __in   DRM_DWORD              f_cbDRMHeaderData );

DRM_RESULT DRM_CALL DRMTOOLS_CloseASFContext(
    IN OUT DRM_TOOLS_ASF_CONTEXT *f_poAsfContext);

...
#define MAC_VERSION_STRING                              _T("4.07")
#define MAC_NAME                                        _T("Monkey's Audio 4.07")
#define PLUGIN_NAME                                     "Monkey's Audio Player v4.07"
#define MJ_PLUGIN_NAME                                  _T("APE Plugin (v4.07)")
#define CONSOLE_NAME                                    "--- Monkey's Audio Console Front End (v 4.07) (c) Matthew T. Ashland ---\n"
#define PLUGIN_ABOUT                                    _T("Monkey's Audio Player v4.07\nCopyrighted (c) 2000-2009 by Matthew T. Ashland")

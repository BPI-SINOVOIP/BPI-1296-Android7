...
typedef enum{
	...
	FILTER_PROP_GET_MEDIAINFO,
	FILTER_PROP_GET_SCANDONE
} FILTER_PROPERTY;
...
// HDMV lpcm audio type
    ...
    /* 1195 Extractor add */
    MEDIASUBTYPE_H265_VIDEO,    // 206
    MEDIASUBTYPE_VP9_VIDEO,     // 207
	MEDIASUBTYPE_VIDEO_RV30,			// 208, RM30
	MEDIASUBTYPE_VIDEO_RV40,			// 209, RM40

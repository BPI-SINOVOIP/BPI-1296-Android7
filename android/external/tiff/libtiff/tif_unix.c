...
_tiffReadProc(thandle_t fd, void* buf, tmsize_t size)
{
	...
	return ((tmsize_t) read((int64) fd, buf, size_io));
#else
...
#if defined(__aarch64__)
	return ((tmsize_t) write((int64) fd, buf, size_io));
#else
...
#if defined(__aarch64__)
	return((uint64)lseek((int64)fd,off_io,whence));
#else
...
#if defined(__aarch64__)
		*pbase = (void*)
		    mmap(0, (size_t)sizem, PROT_READ, MAP_SHARED, (int64) fd, 0);
#else
		*pbase = (void*)

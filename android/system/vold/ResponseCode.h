...
public:
    ...
    static const int DiskNickname = 800; //RealTek pass nickname to MountService.java 

    static const int SmbMountOkay                  = 933;
    static const int SmbMountFailed                = 934;
    static const int SmbUmountOkay                 = 935;
    static const int SmbUmountFailed               = 936;

    static const int NFSMountOkay                  = 940;
    static const int NFSMountFailed                = 941;
    static const int NFSUmountOkay                 = 942;
    static const int NFSUmountFailed               = 943;

...
public:
    ...
    //Smb function
    int SmbMountShare(const char* smbPath, const char* mountPath, const char* user, const char* passwd, const char* domain);
    int SmbUmountShare();
    //NFS function
    int NFSMountShare(const char* nfsPath, const char* mountPath, const char* addr);
    int NFSUmountShare();

...
CommandListener::CommandListener() :
    ...
    registerCmd(new SmbCmd());
    registerCmd(new NFSCmd());
}
...
CommandListener::SmbCmd::SmbCmd() :
                 VoldCommand("smb") {
}

int CommandListener::SmbCmd::runCommand(SocketClient *cli, int argc, char **argv) {
    ...
    if (!strcmp(argv[1], "mount")) {
        ...
        rc = vm->SmbMountShare(argv[2], argv[3], argv[4], argv[5],argv[6]);
    }
    else if (!strcmp(argv[1], "umount"))
    {
        rc = vm->SmbUmountShare();
    }
...
CommandListener::NFSCmd::NFSCmd() :
                 VoldCommand("nfs") {
}

int CommandListener::NFSCmd::runCommand(SocketClient *cli, int argc, char **argv) {
    ...
    if (!strcmp(argv[1], "mount")) {
        ...
        rc = vm->NFSMountShare(argv[2], argv[3], argv[4]);
    }
    else if (!strcmp(argv[1], "umount"))
    {
        rc = vm->NFSUmountShare();
    }

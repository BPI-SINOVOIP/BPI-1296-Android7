...
BUILD_STATIC_MAKE_EXT4FS := true
ifeq ($(BUILD_STATIC_MAKE_EXT4FS),true)
include $(CLEAR_VARS)
LOCAL_SRC_FILES := make_ext4fs_main.c canned_fs_config.c
LOCAL_MODULE := make_ext4fs_static_prebuilt
LOCAL_STATIC_LIBRARIES := libcutils liblog libext2_uuid libext4_utils_static libsparse_static libselinux libmincrypt libz libc

...
int main(int argc, char **argv)
{
    ...
    //when running slideshow, ALSADaemon is not yet running finish,
    //so need sleep slideshow to wait ALSADaemon running finish.
    LOGE("---slideshow start after sleep 5ms!!---\n");
    sleep(5);

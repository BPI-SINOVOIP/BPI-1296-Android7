...
typedef enum android_pixel_format {
    ...
    /*
     * RTK YCbCr 420 format:
     *
     * case 16
     *      y_stride = ALIGN(width,16)
     *      c_stride = y_stride/2
     *      v_stride = ALIGN(height,16)
     *
     *      y_size = v_stride * y_stride
     *      c_size = v_stride * c_stride
     *
     *      size = y_size + c_size
     *      uv_offset = y_size
     *
    ...
    HAL_PIXEL_FORMAT_RTK_16_YCbCr_420_SP = 0x30,    /* legacy */
    HAL_PIXEL_FORMAT_RTK_32_YCbCr_420_SP,           /* legacy */
     ...
     * H : height alignment
     */
    HAL_PIXEL_FORMAT_RTK_W16_H16_YCbCr_420_SP = 0x32,
    HAL_PIXEL_FORMAT_RTK_W32_H16_YCbCr_420_SP,
    HAL_PIXEL_FORMAT_RTK_W16_H32_YCbCr_420_SP,
    HAL_PIXEL_FORMAT_RTK_W32_H32_YCbCr_420_SP,
    HAL_PIXEL_FORMAT_RTK_W16_H8_YCbCr_420_SP,

    HAL_PIXEL_FORMAT_RTK_W16_H16_YCrCb_420_SP = 0x52,
    HAL_PIXEL_FORMAT_RTK_W32_H16_YCrCb_420_SP,
    HAL_PIXEL_FORMAT_RTK_W16_H32_YCrCb_420_SP,
    HAL_PIXEL_FORMAT_RTK_W32_H32_YCrCb_420_SP,
    HAL_PIXEL_FORMAT_RTK_W16_H8_YCrCb_420_SP,

    HAL_PIXEL_FORMAT_RTK_P10_COMPRESSED = 0x40,
    HAL_PIXEL_FORMAT_RTK_P10_LINEAR,
    HAL_PIXEL_FORMAT_RTK_P8_COMPRESSED,
    HAL_PIXEL_FORMAT_RTK_W32_H32_P10_COMPRESSED,
    HAL_PIXEL_FORMAT_RTK_W32_H32_P8_COMPRESSED,

    /*
     * RTK YUV 10 bit format
     *  [31:28]  magic code :        4'b0110 (0x6)
     *  [27]     compressed mode :   1'b1=10bit 1'b0=8bit
     *  [26]     linear mode :       1'b1=10bit 1'b0=8bit
     *  [25:13]  compressed buffer width
     *  [12:0]   compressed buffer height
     *
     * Buffer Stack:
     *  +-----------------------------------------------+
     *  |   HAL_PIXEL_FORMAT_RTK_W32_H32_YCbCr_420_SP   |
     ...
     *  +-----------------------------------------------+
     */
    HAL_PIXEL_FORMAT_RTK_P10_MAGIC_MASK     = 0xf0000000,
    HAL_PIXEL_FORMAT_RTK_P10_MAGIC          = 0x60000000,

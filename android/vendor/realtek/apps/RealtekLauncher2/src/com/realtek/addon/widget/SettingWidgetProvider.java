...
public class SettingWidgetProvider extends AbsRTKWidgetProvider {
	
	@Override
	public Class<?> getMyClass() {
		return SettingWidgetProvider.class;
	}
	...
	public int getLayoutID() {
		return R.layout.wl_setting;
	}

	@Override
	public void onHandleClickIntent(Context c) {
		launchInstalledApkInNewTask(ConstantsDef.SETTING_PKG_NAME, c);
	}

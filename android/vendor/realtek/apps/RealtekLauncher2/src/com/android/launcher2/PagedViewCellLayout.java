...
public class PagedViewCellLayout extends ViewGroup implements Page {
    ...
    public void calculateCellCount(int width, int height, int maxCellCountX, int maxCellCountY) {
        ...
        // COMMENT: nums of row and column is calculated runtime
        // KEYPOINT: key function to calculate mCellCountX and mCellCountY runtime (based on screen width and height)
        DebugHelper.dump("calculateCellCount x:"+mCellCountX+" y:"+mCellCountY);

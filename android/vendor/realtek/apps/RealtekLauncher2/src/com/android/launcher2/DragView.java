...
public class DragView extends View {
     ...
     */
    public DragView(Launcher launcher,
    		Bitmap bitmap,
    		int registrationX, 
    		int registrationY,
            int left,
        ...
        mLauncher=launcher;
        // when a DragView is created, clear FocusView
        launcher.clearWorkspaceFocusViewFrame();
        ...
        mAnim.addUpdateListener(new AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
            	...
            	DebugHelper.dump("DragView onAnimationUpdate [scale]");
        ...
        DebugHelper.dump("DragView: mRegistrationX:"+mRegistrationX);
        DebugHelper.dump("DragView: mRegistrationY:"+mRegistrationY);
    ...
    public void show(int touchX, int touchY) {
    	...
    	DebugHelper.dump("DragView show() at touchX="+touchX+" touchY="+touchY);
    	DebugHelper.dump("DragView show() at mRegistrationX="+mRegistrationX+" mRegistrationY="+mRegistrationY);
    	
        mDragLayer.addView(this);
        mLauncher.uninitSurfaceViewWidget("Enter Drag mode");
    ...
    /**
     * RTKTODO: under fake drag mode, position of dragView is incorrect
    ...
    void move(int touchX, int touchY) {
    	...
    	DebugHelper.dump("---->DragView touch x="+touchX+" y="+touchY);
    	DebugHelper.dump("---->DragView mRegX="+mRegistrationX+" mRegY="+mRegistrationY);
    	DebugHelper.dump("---->DragView mOffsetX="+mOffsetX+" mOffsetY="+mOffsetY);
    ...
    void remove() {
        ...
        mLauncher.initSurfaceViewWidget("Leave Drag mode");
    }
}

...
public class BubbleTextView extends TextView {
    ...
    private boolean bDisableNativeGlowingOutline=true;
    ...
    private void init() {
        ...
        // RTKCOMMENT: test random color...
        //setBackground(createBGDrawable());
        
        
        // RTKCOMMENT: add selector for none focus state
        StateListDrawable states = new StateListDrawable();
        
        // focused state: fixed background
        states.addState(new int[] {android.R.attr.state_focused}, 
        		getResources().getDrawable(R.drawable.focused_bg));
        // other states: random color.
        states.addState(new int[] { }, createBGDrawable());
        ...
        mFocusedOutlineColor = mFocusedGlowColor = mPressedOutlineColor = mPressedGlowColor =
        		CustomizedHelper.getShortcutFocusColor(getContext());
        ...
        // FIX side-effect of BUG_FIX: 42363
    ...
    // COMMENT: this method sets BubbleTextView icon (focused or unfocused).
    ...
    // COMMENT: triggered by drag&drop event.
    void clearPressedOrFocusedBackground() {
    	DebugHelper.dump(""+this+" clearPressedOrFocusedBackground");
        mPressedOrFocusedBackground = null;
        setCellLayoutPressedOrFocusedIcon();
    }

    Bitmap getPressedOrFocusedBackground() {
    	// RTKCOMMENT: always return null to disable original blue focus
    	if(bDisableNativeGlowingOutline)
    		return null;
    ...
    public void draw(Canvas canvas) {
        ...
        /*
        COMMENT: disable this block of code to avoid different level alpha.

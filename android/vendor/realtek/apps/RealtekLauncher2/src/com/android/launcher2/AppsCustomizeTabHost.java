...
public class AppsCustomizeTabHost extends TabHost implements LauncherTransitionable,
    ...
    // RTKCOMMENT: new added for Realtek Launcher
    public static final String FAVORITE_TAB_TAG = "FAVORITE";
    ...
    /**
     * COMMENT: added by Bruce, select Favorite tab, but might be useless.
     */
    public void selectFavoriteTab() {
    	setContentTypeImmediate(AppsCustomizePagedView.ContentType.Favorite);
    }
    
    /**
     * COMMENT: added by Bruce, select Video tab, but might be useless.
     */
    public void selectVideoTab() {
    	setContentTypeImmediate(AppsCustomizePagedView.ContentType.Video);
    }
    ...
    protected void onFinishInflate() {
        ...
        // COMMENT: where number of [tabs] is decided.
        ...
        /* favorite */
        label = getContext().getString(R.string.favorite_tab_label);
        tabView = (TextView) mLayoutInflater.inflate(R.layout.tab_widget_indicator, tabs, false);
        tabView.setText(label);
        tabView.setContentDescription(label);
        addTab(newTabSpec(FAVORITE_TAB_TAG).setIndicator(tabView).setContent(contentFactory));
        
        /* video */
        label = getContext().getString(R.string.video_tab_label);
        tabView = (TextView) mLayoutInflater.inflate(R.layout.tab_widget_indicator, tabs, false);
        tabView.setText(label);
        tabView.setContentDescription(label);
        addTab(newTabSpec(VIDEO_TAB_TAG).setIndicator(tabView).setContent(contentFactory));
    ...
    // RTKCOMMENT: refer this part of code to see how launcher handle TAB changed event
    @Override
    public void onTabChanged(String tabId) {
    	
    	
    	// TODO: aware favorite and video page
    	DebugHelper.dump("onTabChanged: "+tabId);
    ...
    public AppsCustomizePagedView.ContentType getContentTypeForTabTag(String tag) {
        ...
        // COMMENT: add favorite, video type by Bruce
        else if(tag.equals(FAVORITE_TAB_TAG)) {
        	return AppsCustomizePagedView.ContentType.Favorite;
        } else if (tag.equals(VIDEO_TAB_TAG)) {
        	return AppsCustomizePagedView.ContentType.Video;
        }
     ...
     * RTKTODO: consider video tab and favorite tab, used when switching TAB by scrolling
     */
    public String getTabTagForContentType(AppsCustomizePagedView.ContentType type) {
        ...
        }else if (type == AppsCustomizePagedView.ContentType.Favorite){
        	return FAVORITE_TAB_TAG;
        }else if (type == AppsCustomizePagedView.ContentType.Video){
        	return VIDEO_TAB_TAG;
        }
        return APPS_TAB_TAG;
    }

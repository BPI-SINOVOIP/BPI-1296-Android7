...
public class LauncherProvider extends ContentProvider {
    ...
    private static final String DATABASE_NAME = "rtklauncher.db";

    private static final int DATABASE_VERSION = 12;

    static final String AUTHORITY = "com.realtek.launcher2.settings";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private ComponentName getSearchWidgetProvider() {
            ...
            ComponentName searchComponent = CustomizedHelper.getFakeSearchActivity();//searchManager.getGlobalSearchActivity();

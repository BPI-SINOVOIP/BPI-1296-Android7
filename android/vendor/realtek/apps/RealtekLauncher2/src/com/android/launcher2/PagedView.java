...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    public void jumpToPageWithoutAni(int whichPage){
    	mNextPage = whichPage;
        ...
        // loading associated pages until the scroll settles
        if (mDeferScrollUpdate) {
            loadAssociatedPages(mNextPage,true);
        } else {
            mDeferLoadAssociatedPagesUntilScrollCompletes = true;
        }
        notifyPageSwitchListener();
    ...
    protected void loadAssociatedPages(int page, boolean immediateAndOnly) {
    	...
    	DebugHelper.dump("loadAssociatedPages page:"+page);
                ...
                for (int i = 0; i < count; ++i) {
                    ...
                    if (lowerPageBound <= i && i <= upperPageBound) {
                        if (mDirtyPageContent.get(i)) {
                        	...
                        	DebugHelper.dump("loadAssociatedPages clear dirtyPageCount:"+i);
    ...
    protected View getScrollingIndicator() {
    	...
    	DebugHelper.dump("---------> PagedView getScrollingIndicator");

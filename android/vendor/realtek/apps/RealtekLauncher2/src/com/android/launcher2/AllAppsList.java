...
public class AllAppsList {
    ...
    /**
     * find ApplicationInfo object via packageName, for Realtek launcher.
     * @param packageName
     * @return
     */
    public static ApplicationInfo findAppInfoByPackageName(String packageName, ArrayList<ApplicationInfo> list){

...
public class DeleteDropTarget extends ButtonDropTarget {
    ...
    public boolean acceptDrop(DragObject d) {
        ...
        // Prevent DTV widget and App widget been deleted by drop
        if(d.dragInfo instanceof LauncherAppWidgetInfo){
            LauncherAppWidgetInfo info = (LauncherAppWidgetInfo)d.dragInfo;
            if(info.providerName.getClassName().equals(AppDrawerWidgetProvider.class.getName()))
                return false;
            if(info.providerName.getClassName().equals(DtvWidgetProvider.class.getName())){
                Log.i("DeleteDropTarget","acceptDrop - DTV return false");
                return false;
            }
        }
        return true;
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        // check if is removable widget and update isVisible value
        if(source instanceof Workspace){
            if(info instanceof LauncherAppWidgetInfo){
                LauncherAppWidgetInfo appWidgetInfo = (LauncherAppWidgetInfo)info;
                if(appWidgetInfo.providerName.getClassName().equals(AppDrawerWidgetProvider.class.getName()))
                    isVisible=false;
                if(appWidgetInfo.providerName.getClassName().equals(DtvWidgetProvider.class.getName()))
                    isVisible=false;
            }
        }
    ...
    public void onDrop(DragObject d) {
        ...
        Log.i("DeleteDropTarget", "onDrop:"+d);
        ...
        if(d.dragInfo instanceof LauncherAppWidgetInfo){
            ...
            if(info.providerName.getClassName().equals(AppDrawerWidgetProvider.class.getName()))
                return;
            if(info.providerName.getClassName().equals(DtvWidgetProvider.class.getName())){
                Log.i("DeleteDropTarget","onDrop of DTVWidget, do nothing");
                return;
            }
        }

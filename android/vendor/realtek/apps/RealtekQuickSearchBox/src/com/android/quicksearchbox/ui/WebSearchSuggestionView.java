...
public class WebSearchSuggestionView extends BaseSuggestionView {
    ...
    protected void onFinishInflate() {
        ...
        mIcon2.setOnFocusChangeListener(new Icon2FocusListener());
    }
...
//        setIsHistorySuggestion(suggestion.isHistorySuggestion());
    ...
    private class Icon2FocusListener implements OnFocusChangeListener {
        public void onFocusChange(View v, boolean focused) {

			if (focused)
			{
				((ImageView)v).setImageResource(R.drawable.us_google_suggestion);
			}
			else
			{
				((ImageView)v).setImageResource(R.drawable.us_google_suggestion_none);
			}
        }
    }
}

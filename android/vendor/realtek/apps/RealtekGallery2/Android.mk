...
ifneq (,$(TARGET_BUILD_APPS))
  LOCAL_JNI_SHARED_LIBRARIES := libjni_eglfence_RTK libjni_filtershow_filters_RTK librsjni libjni_jpegstream_RTK
else
  LOCAL_REQUIRED_MODULES := libjni_eglfence_RTK libjni_filtershow_filters_RTK libjni_jpegstream_RTK
endif

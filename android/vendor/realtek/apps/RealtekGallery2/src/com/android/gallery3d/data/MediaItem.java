...
public abstract class MediaItem extends MediaObject {
    ...
    public static final int TYPE_LARGETHUMBNAIL = 3;
    ...
    private static int sLargeThumbnailTargetSize = 1280;
    ...
    public static void setThumbnailSizes(int largeSize, int size, int microSize) {
        sLargeThumbnailTargetSize = largeSize;

...
public class MtpDeviceIndex {
    ...
    private static final String TAG = "MtpDeviceIndex";
    ...
    private IndexRunnable mRunnable= null;
    ...
    synchronized public Runnable getIndexRunnable() {
        ...
        mRunnable = new IndexRunnable(mDevice);
        return mRunnable;
    }
    ...
    synchronized public void stopIndex() {
        mRunnable.IndexStop();
    }
    ...
    private class IndexRunnable implements Runnable {
        ...
        @Override
        public void run() {
            while(mNumObjects == 0 && mStop == 0){
                try {
                    indexDevice();
                } catch (IndexingException e) {
                    Log.d(TAG, "indexDevice: " + e);
            ...
            for (int storageId : mDevice.getStorageIds()) {
                ...
                while (!pendingDirectories.isEmpty()) {
                    ...
                    for (int objectHandle : mDevice.getObjectHandles(storageId, 0, dirHandle)) {
                        Log.d(TAG, "objectHandle: " + objectHandle);
                        ...
                        if (format == MtpConstants.FORMAT_ASSOCIATION) {
                            ...
                            Log.d(TAG, "add Object: " + objectInfo.getName());

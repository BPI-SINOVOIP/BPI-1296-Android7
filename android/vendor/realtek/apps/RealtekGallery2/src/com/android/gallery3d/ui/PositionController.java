...
class PositionController {
    ...
    public PositionController(Context context, Listener listener) {
        ...
        if(GalleryUtils.useReal4KPhoto() == true) {
            ANIM_TIME[ANIM_KIND_SNAPBACK] = 0;
            ANIM_TIME[ANIM_KIND_SLIDE] = 0;
            ANIM_TIME[ANIM_KIND_ZOOM] = 0;
            ANIM_TIME[ANIM_KIND_OPENING] = 0;
        }
    }
    ...
    public void zoomIn(float targetScale) {
        ...
        float tempX = mPlatform.mCurrentX / b.mCurrentScale;
        float tempY = b.mCurrentY / b.mCurrentScale;

...
public class IngestService extends Service implements ImportTask.Listener,
    ...
    private static final String TAG = "IngestService";
    ...
    private Thread mIndexThread = null;
    ...
    private void setDevice(MtpDevice device) {
        ...
        if (mDevice != null) {
            ...
            if (deviceInfo == null) {
                ...
                Log.d(TAG, "start IndexRunnable");
                mIndexThread = new Thread(mIndex.getIndexRunnable());
                mIndexThread.start();
            }
        } else {

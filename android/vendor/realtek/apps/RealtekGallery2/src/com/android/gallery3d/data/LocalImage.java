...
public class LocalImage extends LocalMediaItem {
    ...
    public static class LocalImageRequest extends ImageCacheRequest {
        ...
        public Bitmap onDecodeOriginal(JobContext jc, final int type) {
            ...
            if(mLocalFilePath.toLowerCase().endsWith("heic") || mLocalFilePath.toLowerCase().endsWith("heic")) {
                HeifReader heifReader = new HeifReader(mApplication.getAndroidContext(), mLocalFilePath, null);
                return heifReader.decodeHeif();
            }
            else {
    ...
    public static class LocalLargeImageRequest
        ...
        public BitmapRegionDecoder run(JobContext jc) {
            Log.d(TAG, "LocalLargeImageRequest : " + mLocalFilePath);
    ...
    public void rotate(int degrees) {
        ...
        else if(mimeType.equalsIgnoreCase("image/heic") || mimeType.equalsIgnoreCase("image/heif")) {
            HeifReader heifReader = new HeifReader(mApplication.getAndroidContext(), filePath, null);
            rotation = heifReader.getRotation();
        }

...
import com.rtk.debug.data.LogLine;
import com.rtk.debug.data.SearchCriteria;
import com.rtk.debug.helper.PreferenceHelper;
import com.rtk.debug.helper.SaveLogHelper;
import com.rtk.debug.helper.ServiceHelper;
import com.rtk.debug.reader.LogcatReader;
import com.rtk.debug.reader.LogcatReaderLoader;
import com.rtk.debug.util.ArrayUtil;
import com.rtk.debug.util.LogLineAdapterUtil;
...
public class LogcatRecordingService extends IntentService {
	...
	private BroadcastReceiver receiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			killProcess();
			ServiceHelper.stopBackgroundServiceIfRunning(context, LogcatRecordingService.class);
		}
	};

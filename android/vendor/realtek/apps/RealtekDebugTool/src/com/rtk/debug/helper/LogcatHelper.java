...
public class LogcatHelper {
	...
	public static Process getLogcatToFileProcess(String buffer, String filePath) throws IOException {

		List<String> args = getLogcatArgs(buffer);
		args.add("-f");
		args.add(filePath);
		Log.i("LogcatHelper", "save log to "+filePath);
		Process process = RuntimeHelper.exec(args);
		return process;
	}
	
	private static List<String> getLogcatArgs(String buffer) {
		List<String> args = new ArrayList<String>(Arrays.asList("logcat"));

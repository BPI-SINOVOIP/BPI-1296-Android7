...
void PointerController::SetVisible(bool bVisible)
{
	mbVisible = bVisible;
	if (mbVisible)
		unfade(PointerControllerInterface::TRANSITION_IMMEDIATE);
	else 
		fade(PointerControllerInterface::TRANSITION_IMMEDIATE);
}

bool PointerController::GetVisible()
{
	return mbVisible;
}
...
void PointerController::updatePointerLocked() {
	...
	if (mbVisible && mLocked.pointerAlpha > 0) {

...
public:
            ...
            mSetMimeTypeMethodID(0)
    {
        ...
        if (mediaScannerClientInterface == NULL) {
            ...
            //[RTK Begin]
            //change void type to int
            mScanFileMethodID = env->GetMethodID(
                                    mediaScannerClientInterface,
                                    "scanFile",
                                    "(Ljava/lang/String;JJZZ)I");
            //[RTK End]
            ...
            long long fileSize, bool isDirectory, bool noMedia)
    {
        ...
        //[RTK Begin]
        int ret = mEnv->CallIntMethod(mClient, mScanFileMethodID, pathStr, lastModified,
                    fileSize, isDirectory, noMedia);

        mEnv->DeleteLocalRef(pathStr);
        int ret2 = checkAndClearExceptionFromCallback(mEnv, "scanFile");
        return (ret2==OK)?ret:ret2;
        //[RTK End]
    }
...
static void
android_media_MediaScanner_setNativeForceStopProperty(
        JNIEnv *env, jobject thiz, jboolean stop)
{
    ALOGV("setNativeForceStopProperty");
    MediaScanner *mp = getNativeScanner_l(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, kRunTimeException, "No scanner available");
        return;
    ...
    mp->setNativeForceStopProperty(stop);
}
...
static const JNINativeMethod gMethods[] = {
    ...
    {
        "setNativeForceStopProperty",
        "(Z)V",
        (void *)android_media_MediaScanner_setNativeForceStopProperty
    },

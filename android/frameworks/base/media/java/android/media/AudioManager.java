...
public class AudioManager {
    ...
    public void adjustStreamVolume(int streamType, int direction, int flags) {
        ...
        //Log.i(TAG, "adjStreamVol:" + streamType + " with direction=" + 
        //                direction + " (useMaster=" + mUseMasterVolume + ")");
        try {
    ...
    public void setMasterMute(boolean mute, int flags) {
        IAudioService service = getService();
        //Log.i(TAG, "adjMasterVol. steps=" + steps);
        try {
    ...
    */
    ...
    /**
     * Sets the HDMIRX state to the AudioPolicyManagerBase.
     *
     * @param state set <var>true</var> on connected;
     *                 <var>false</var> on disconnected;
     */
    public void setHDMIRXstate(boolean state){
        AudioSystem.setHDMIRXstate(state);
    }
}

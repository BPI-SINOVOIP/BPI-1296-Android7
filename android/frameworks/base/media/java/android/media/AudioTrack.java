                        ...
                        implements AudioRouting
{
    ...
    public AudioTrack(AudioAttributes attributes, AudioFormat format, int bufferSizeInBytes,
        ...
        if ((mAttributes.getFlags() & AudioAttributes.FLAG_HW_AV_SYNC) != 0) {
            ...
            Log.d(TAG, "HW_AV_SYNC: Audio Format " + mAudioFormat + " mChannelCount " + mChannelCount + " frameSizeInBytes " + frameSizeInBytes + " Offset " + mOffset);
        }
...
//rtk modify
            /* ATM-968 CTS expect to receive exception for IEC61937 MONO and 5POINT1 */
            if(channelConfig == AudioFormat.CHANNEL_OUT_MONO
                    || channelConfig == AudioFormat.CHANNEL_OUT_5POINT1)
                throw new IllegalArgumentException(
                        "ENCODING_IEC61937 must be configured as CHANNEL_OUT_STEREO");
            else /* KODI needs AudioFormat.CHANNEL_OUT_7POINT1_SURROUND */
                Log.d(TAG ,"ENCODING_IEC6193 channel not STEREO");
//rtk end
        }

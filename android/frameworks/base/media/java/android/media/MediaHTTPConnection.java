    ...
    private void seekTo(long offset) throws IOException {
        ...
        try {
            ...
            while (true) {
                ...
                mConnection.setReadTimeout(READ_TIMEOUT_MS);
            ...
            if (offset > 0 && response != HttpURLConnection.HTTP_PARTIAL) {
                ...
                Log.d(TAG, String.format("mTotalSize=%d, mCurrentOffset=%d, offset=%d", mTotalSize, mCurrentOffset, offset));
                mInputStream =

...
final public class MediaMuxer {
    ...
    public static final class OutputFormat {
        ...
        public static final int MUXER_OUTPUT_MPEG2TS   = 2;
    };
    ...
    @IntDef({
        ...
        OutputFormat.MUXER_OUTPUT_MPEG2TS,
    })
    ...
    public MediaMuxer(@NonNull String path, @Format int format) throws IOException {
        ...
        if (format != OutputFormat.MUXER_OUTPUT_MPEG_4 &&
                ...
                format != OutputFormat.MUXER_OUTPUT_MPEG2TS) {
    ...
    public MediaMuxer(@NonNull ParcelFileDescriptor pfd, @Format int format) throws IOException {
        if (pfd == null) {
            throw new IllegalArgumentException("pfd must not be null");
        }
        if (format != OutputFormat.MUXER_OUTPUT_MPEG_4 &&
                format != OutputFormat.MUXER_OUTPUT_WEBM &&
                format != OutputFormat.MUXER_OUTPUT_MPEG2TS) {

...
interface IMediaScannerService
{
    ...
    /**
     * To rescan the external.db and external-xxx.db SQLite database
     * @param volumeRootPath the path to the volume to be scanned.
    **/
//    void rescanVolume(String volumeRootPath);
}

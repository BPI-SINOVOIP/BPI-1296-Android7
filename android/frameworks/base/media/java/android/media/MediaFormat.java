...
public final class MediaFormat {
    ...
    public static final String MIMETYPE_AUDIO_MPEG_LAYER_I = "audio/mpeg-L1";
    public static final String MIMETYPE_AUDIO_MPEG_LAYER_II = "audio/mpeg-L2";
    ...
    public static final String MIMETYPE_AUDIO_AAC_ADTS = "audio/aac-adts";
    public static final String MIMETYPE_AUDIO_AAC_LATM = "audio/aac-latm";
    public static final String MIMETYPE_AUDIO_DDP = "audio/eac3";
    public static final String MIMETYPE_AUDIO_DTS = "audio/dts";
    public static final String MIMETYPE_AUDIO_DTS_HD = "audio/dts-hd";
    public static final String MIMETYPE_AUDIO_WMA = "audio/wma";
    public static final String MIMETYPE_AUDIO_WMAPRO = "audio/wmapro";
    public static final String MIMETYPE_AUDIO_LPCM = "audio/lpcm";

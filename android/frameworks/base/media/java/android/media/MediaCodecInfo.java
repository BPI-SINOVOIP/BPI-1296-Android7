    ...
    public static final class AudioCapabilities {
        ...
        private void applyLevelLimits() {
            ...
            if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_MPEG) ||
                mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_MPEG_LAYER_I) ||
                mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_MPEG_LAYER_II)) {
                sampleRates = new int[] {
                        8000, 11025, 12000,
                        16000, 22050, 24000,
                        32000, 44100, 48000 };
                ...
                mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_AAC_LATM)) {
                sampleRates = new int[] {
                        7350, 8000,
                        11025, 12000, 16000,
                        22050, 24000, 32000,
                ...
                mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_DDP) ||
                mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_DTS) ||
                mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_DTS_HD) ||
                mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_WMA) ||
                mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_WMAPRO) ||
                mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_LPCM)) {
                sampleRateRange = Range.create(1, 96000);
                maxChannels = 8;
            } else {

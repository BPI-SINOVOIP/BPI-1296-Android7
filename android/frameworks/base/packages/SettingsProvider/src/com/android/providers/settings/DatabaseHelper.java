...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int currentVersion) {
       ...
       if (upgradeVersion == 51) {
		...
		// for Realtek DvdPlayer usage.
        if (upgradeVersion == 98) {
            Log.d(TAG, "onUpgrade(): Realtek DvdPlayer, stanely tested.");
			if (mUserHandle == UserHandle.USER_OWNER) {
				...
				try {
                    ...
                    loadIntegerSetting(stmt, Settings.System.REALTEK_SETUP_TV_STANDARD, 
							R.integer.def_realtek_setup_tv_standard);

                    loadIntegerSetting(stmt, Settings.System.REALTEK_SETUP_REAL_TV_SYSTEM, 
							R.integer.def_realtek_setup_real_tv_system);

                    loadIntegerSetting(stmt, Settings.System.REALTEK_SETUP_TV_SYSTEM_USER,
                            R.integer.def_realtek_setup_tv_system_user);

                    loadIntegerSetting(stmt, Settings.System.REALTEK_SETUP_ASPECT_RATIO, 
							R.integer.def_realtek_setup_aspect_ratio);

                    loadIntegerSetting(stmt, Settings.System.REALTEK_SETUP_CURRENT_HDMI_TV_VID, 
							R.integer.def_realtek_setup_current_hdmi_tv_vid);

                    loadIntegerSetting(stmt, Settings.System.REALTEK_SETUP_TV_SYSTEM_AUTO_MODE, 
							R.integer.def_realtek_setup_tv_system_auto_mode);

                    loadIntegerSetting(stmt, Settings.System.REALTEK_SETUP_TV_SYSTEM_MANUAL, 
							R.integer.def_realtek_setup_tv_system_manual);

                    loadIntegerSetting(stmt, Settings.System.REALTEK_SETUP_TV_STANDARD_MANUAL, 
							R.integer.def_realtek_setup_tv_standard_manual);

                    loadIntegerSetting(stmt, Settings.System.REALTEK_SETUP_VIDEO_VGA_RESOLUTION, 
							R.integer.def_realtek_setup_video_vga_resolution);

                    loadIntegerSetting(stmt, Settings.System.REALTEK_SETUP_VIDEO_OUTPUT, 
							R.integer.def_realtek_setup_video_output);

                    loadStringSetting(stmt, Settings.System.REALTEK_SETUP_DLNA_DMS_DEVICE_NAME, 
							R.string.def_realtek_setup_dlna_dms_device_name);

                    loadStringSetting(stmt, Settings.System.REALTEK_SETUP_DLNA_DMS_DEVICE_UUID, 
							R.string.def_realtek_setup_dlna_dms_device_uuid);
            
					loadBooleanSetting(stmt, Settings.System.REALTEK_SETUP_DLNA_DMR_MODE_ON,
                    		R.bool.def_realtek_setup_dlna_dmr_on);

					loadBooleanSetting(stmt, Settings.System.REALTEK_SETUP_SAMBA_SERVER_MODE_ON,
                    		R.bool.def_realtek_setup_samba_server_on);

					loadStringSetting(stmt, Settings.System.REALTEK_SETUP_PLAYBACK_EFFECT_MODE,
                    		R.string.def_realtek_setup_playback_effect_mode);

                    loadStringSetting(stmt, Settings.System.REALTEK_SETUP_SOFTAP_WPS_METHOD, 
							R.string.def_realtek_setup_softap_wps_method);

					loadStringSetting(stmt, Settings.System.REALTEK_SETUP_IRDA_CEC_SWITCH,
                    		R.string.def_realtek_setup_irda_cec_switch);

					loadBooleanSetting(stmt, Settings.System.REALTEK_SETUP_SCREEN_ZOOM_ON,
                    		R.bool.def_realtek_setup_screen_zoom_on);

					loadBooleanSetting(stmt, Settings.System.REALTEK_SETUP_USER_HAVE_AMPLIFIER_ON,
                    		R.bool.def_realtek_setup_user_have_amplifier_on);

					loadBooleanSetting(stmt, Settings.System.REALTEK_SETUP_USER_HAVE_AMPLIFIER_51CH_OUTPUT_ON, 
							R.bool.def_realtek_setup_user_have_amplifier_51ch_output_on);

					loadBooleanSetting(stmt, Settings.System.REALTEK_SETUP_USER_HAVE_AMPLIFIER_71CH_OUTPUT_ON, 
							R.bool.def_realtek_setup_user_have_amplifier_71ch_output_on);

					loadStringSetting(stmt, Settings.System.REALTEK_SETUP_HDMI_OUTPUT_MODE, 
							R.string.def_realtek_setup_hdmi_ouput_mode);

					loadStringSetting(stmt, Settings.System.REALTEK_SETUP_SPDIF_OUTPUT_MODE, 
							R.string.def_realtek_setup_spdif_ouput_mode);

					loadStringSetting(stmt, Settings.System.REALTEK_SETUP_TEXT_ENCODING_MODE, 
							R.string.def_realtek_setup_text_encoding_mode);

					loadStringSetting(stmt, Settings.System.REALTEK_SETUP_CGI_UPLOAD_FILE_PATH, 
							R.string.def_realtek_setup_cgi_upload_file_path);

					loadBooleanSetting(stmt, Settings.System.REALTEK_SETUP_MIRACAST_SINK_TOGGLE_ON,
                    		R.bool.def_realtek_setup_miracast_sink_toggle_on);

					loadBooleanSetting(stmt, Settings.System.REALTEK_SETUP_MIRACAST_SINK_CONNECTION_REMINDER_ON,
                    		R.bool.def_realtek_setup_miracast_sink_connection_reminder_on);

                    loadStringSetting(stmt, Settings.System.REALTEK_SETUP_MIRACAST_SINK_PIN_CODE,
                            R.string.def_realtek_setup_miracast_sink_pin_code);

                    loadIntegerSetting(stmt, Settings.System.REALTEK_DEEP_COLOR_MODE,
                            R.integer.def_realtek_deep_color_mode);

                    loadBooleanSetting(stmt, Settings.System.REALTEK_IS_DEVICE_NAME_CHANGED_BY_USER,
                           R.bool.def_realtek_is_def_device_name_changed_by_user);
                    
                    loadBooleanSetting(stmt, Settings.System.REALTEK_IS_WIFI_MACADDR_READY,
                           R.bool.def_realtek_is_wifi_macAddr_ready);
                    
                    loadStringSetting(stmt, Settings.System.REALTEK_DEFAULT_DEVICE_NAME,
                           R.string.def_realtek_def_deivce_name);

                    loadBooleanSetting(stmt, Settings.System.REALTEK_IGNORE_HDMI_PLUGOUT,
                            R.bool.def_realtek_ignore_hdmi_plugout);

                    loadBooleanSetting(stmt, Settings.System.REALTEK_SETUP_AUTO_1080P24,
                            R.bool.def_realtek_setup_auto_1080p24);

                    loadBooleanSetting(stmt, Settings.System.REALTEK_YST_MODE,
                            R.bool.def_realtek_yst_mode);

                    loadBooleanSetting(stmt, Settings.System.REALTEK_SETUP_AUTO_2997HZ,
                            R.bool.def_realtek_setup_auto_2997hz);

                    loadBooleanSetting(stmt, Settings.System.REALTEK_SETUP_FORCE_SDAUDIO,
                            R.bool.def_realtek_setup_force_sdaudio);
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadBooleanSetting(stmt, Settings.System.REALTEK_FORCE_RT_MEDIAPLAYER, 
                    R.bool.def_realtek_force_rt_mediaplayer_on);
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadIntegerSetting(stmt, Settings.Global.CAPTIVE_PORTAL_DETECTION_ENABLED,
                    R.integer.def_connectivity_check_enabled);
            loadStringSetting(stmt, Settings.Global.CAPTIVE_PORTAL_SERVER,
                    R.string.def_connectivity_check_url);
            loadStringSetting(stmt, Settings.Global.HDMI_CEC_POWER_ON_FROM_TV,
                    R.integer.def_hdmi_cec_power_on_from_tv);

...
public final class LocalBluetoothProfileManager {
    ...
    synchronized void updateProfiles(ParcelUuid[] uuids, ParcelUuid[] localUuids,
        ...
        if (BluetoothUuid.containsAnyUuid(uuids, A2dpProfile.SINK_UUIDS) &&
            ...
            //DHCKYLIN-3604, Add for bt src/sink. When sink switch to src, update mA2dpProfile.
            //Can not be removed from removedProfiles.
            for (LocalBluetoothProfile profile : removedProfiles) {
                if (profile instanceof A2dpProfile) {
                    removedProfiles.remove(profile);
                    break;
                }
            }
        }
    ...
    /**
     *Add for bluetooth sink src service. When sink service is connected,
     *BluetoothA2dp service is disconnected. When src service connect again,
     *A2dpProfile should be updated.
     */
    public void updateA2dpProfile() {
        Log.d(TAG, "updateA2dpProfile");
        if (mA2dpProfile != null) {
            mA2dpProfile = null;
        }
        mA2dpProfile = new A2dpProfile(mContext, mLocalAdapter, mDeviceManager, this);
    ...
    /**
     *DHCFAE-4015,Add for bluetooth sink src service. When src service is connected,
     *BluetoothA2dpSink service is disconnected. When sink service connect again,
     *A2dpSinkProfile should be updated.
     */
    public void updateA2dpSinkProfile() {
        Log.d(TAG, "updateA2dpSinkProfile");
        if (mA2dpSinkProfile != null) {
            mA2dpSinkProfile = null;
        }
        mA2dpSinkProfile = new A2dpSinkProfile(mContext, mLocalAdapter, mDeviceManager, this);

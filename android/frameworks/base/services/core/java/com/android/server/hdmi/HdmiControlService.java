...
import static com.android.server.hdmi.Constants.OPTION_CEC_POWER_ON_FROM_TV;
...
public final class HdmiControlService extends SystemService {
    ...
    private void registerContentObserver() {
        ...
        String[] settings = new String[] {
                ...
                Global.HDMI_CEC_POWER_ON_FROM_TV
        };
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            switch (option) {
                ...
                case Global.MHL_POWER_CHARGE_ENABLED:
                    ...
                    break;
                case Global.HDMI_CEC_POWER_ON_FROM_TV:
                    //set standby mode
                    setCecOption(OPTION_CEC_POWER_ON_FROM_TV, toInt(enabled));
                    break;
            }
        }
    }
    ...
    private void initializeCec(int initiatedBy) {
        ...
        boolean enabled = readBooleanSetting(Global.HDMI_CEC_POWER_ON_FROM_TV, false);
        mCecController.setOption(OPTION_CEC_POWER_ON_FROM_TV, enabled?1:0);

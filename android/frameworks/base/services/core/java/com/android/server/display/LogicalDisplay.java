...
final class LogicalDisplay {
    ...
    public void configureDisplayInTransactionLocked(DisplayDevice device,
        ...
        // RTK : Overwrite the Width and Height. (do not full screen)
        int osdWidth = SystemProperties.getInt("rtk.hwc.osd.w", 0);
        int osdHeight = SystemProperties.getInt("rtk.hwc.osd.h", 0);
        if (osdWidth > 0 && osdHeight > 0) {
            physWidth = rotated ? osdHeight : osdWidth;
            physHeight = rotated ? osdWidth : osdHeight;
        }

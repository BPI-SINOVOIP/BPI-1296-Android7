...
final class HdmiCecLocalDevicePlayback extends HdmiCecLocalDevice {
    ...
    protected void onAddressAllocated(int logicalAddress, int reason) {
        ...
        //RealTek customized behavior, request Language from TV.  
        if (SystemProperties.getBoolean("persist.rtk.cec.setlanguage",true) && SystemProperties.getBoolean("persist.rtk.cec.asklanguage",false)){
            mService.sendCecCommand(HdmiCecMessageBuilder.buildGetMenuLanguageCommand(mAddress));
        }
        startQueuedActions();
    }

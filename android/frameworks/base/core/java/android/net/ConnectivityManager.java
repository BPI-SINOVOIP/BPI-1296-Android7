...
public class ConnectivityManager {
    ...
    /**
     * The pppoe connection.  When active, all data traffic
     * will use this network type's interface by default
     * (it has a default route)
     */
    ...
    public NetworkInfo getActiveNetworkInfo() {
        if(OpenWrtNetUtils.isEnabled())
            return OpenWrtNetUtils.getActiveNetworkInfo();
        try {
    ...
    public NetworkInfo getActiveNetworkInfoForUid(int uid) {
        if(OpenWrtNetUtils.isEnabled())
            return OpenWrtNetUtils.getActiveNetworkInfoForUid(uid);
    ...
    public NetworkInfo getNetworkInfo(int networkType) {
        if(OpenWrtNetUtils.isEnabled())
            return OpenWrtNetUtils.getNetworkInfo(networkType);
        try {
    ...
    public NetworkInfo[] getAllNetworkInfo() {
        try {
            if(OpenWrtNetUtils.isEnabled())
                return OpenWrtNetUtils.getAllNetworkInfo(mService.getAllNetworkInfo());
    ...
    public boolean isActiveNetworkMetered() {
        if(OpenWrtNetUtils.isEnabled())
            return OpenWrtNetUtils.isActiveNetworkMetered();
        try {

...
public class Intent implements Parcelable, Cloneable {
     ...
     * </ul>
     * <ul>
     * <li> {@link #EXTRA_SHUTDOWN_FOR_REBOOT} a boolean that is set to true if a reboot will go 
     * along with this shutdown.  If not set, assumed to be false.
     * </ul>
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
   ...
   /**
	...
	public static final String ACTION_WEBSERVER_MODE_CHANGED = "android.intent.action.WEBSERVER_MODE"; 
    ...
    /**
     * Add by RTK. Optional extra for {@link #ACTION_SHUTDOWN} that allows the sender to qualify that
     * have reboot along with this shutdown.
     */
    public static final String EXTRA_SHUTDOWN_FOR_REBOOT
            = "android.intent.extra.SHUTDOWN_FOR_REBOOT";
    /*

...
public final class Settings {
	...
	public static final String ACTION_WEBSERVER_MODE_SETTINGS =
			"android.settings.WEBSERVER_MODE_SETTINGS";
    /**
    ...
    public static final class System extends NameValueTable {
        ...
        static {
            ...
            MOVED_TO_GLOBAL.add(Settings.Global.DEBUG_VIEW_ATTRIBUTES);
        }
	    ...
	    public static final String SHOW_MOUSECURSOR = "show_mousecursor";
        ...
        /**
         * Realtek tv system setting.
         * This is an integer for tv system.
         ...
         *	} ENUM_VIDEO_SYSTEM;
         */
        public static final String REALTEK_SETUP_TV_SYSTEM = "realtek_setup_tv_system";

        /**
         * Realtek tv system setting for UI.
         * This is an integer for tv system.
         ...
         * public static final int TV_SYS_NUM = 15;
         */
        public static final String REALTEK_SETUP_TV_SYSTEM_USER = "realtek_setup_tv_system_user";

        /**
         * Realtek tv standard setting.
         * This is an integer for tv standard.
		 * typedef enum video_standard {
		 * VIDEO_INTERLACED,
         * VIDEO_PROGRESSIVE,
         * } ENUM_VIDEO_STANDARD;
         */
        public static final String REALTEK_SETUP_TV_STANDARD = "realtek_setup_tv_standard";

        /**
         * Realtek real tv system setting.
         * This is an integer for real tv system.
		 *	typedef enum video_system {
         *	VIDEO_NTSC,
         *	VIDEO_PAL,
         *	VIDEO_HD720_50HZ,  // 720 only have progressive
         ...
         *	} ENUM_VIDEO_SYSTEM;
         */
        public static final String REALTEK_SETUP_REAL_TV_SYSTEM = "realtek_setup_real_tv_system";

        /**
         * Realtek aspect ratio setting.
         * This is an integer for aspect ratio.
		 *
		 ...
		 * } ENUM_RESCALE_MODE;
		 *
		 * Below is the original usage for aspect ratio.
         ...
         * } ENUM_ASPECT_RATIO;
         */
        public static final String REALTEK_SETUP_ASPECT_RATIO = "realtek_setup_aspect_ratio";

        /**
         * Realtek current hdmi tv vid setting.
         * This is an integer for current hdmi tv vid.
         */
        public static final String REALTEK_SETUP_CURRENT_HDMI_TV_VID = "realtek_setup_current_hdmi_tv_vid";

        /**
         * Realtek tv system auto mode setting.
         * This is an integer for tv system auto mode.
         ...
         */
        public static final String REALTEK_SETUP_TV_SYSTEM_AUTO_MODE = "realtek_setup_tv_system_auto_mode";

        /**
         * Realtek tv system manual setting.
         * This is an integer for tv system manual.
		 *	typedef enum video_system {
         *	VIDEO_NTSC,
         *	VIDEO_PAL,
         *	VIDEO_HD720_50HZ,  // 720 only have progressive
         ...
         *	} ENUM_VIDEO_SYSTEM;
         */
        public static final String REALTEK_SETUP_TV_SYSTEM_MANUAL = "realtek_setup_tv_system_manual";

        /**
         * Realtek tv standard manual setting.
         * This is an integer for tv standard manual.
		 * typedef enum video_standard {
		 * VIDEO_INTERLACED,
         * VIDEO_PROGRESSIVE,
         * } ENUM_VIDEO_STANDARD;
         */
        public static final String REALTEK_SETUP_TV_STANDARD_MANUAL = "realtek_setup_tv_standard_manual";

        /**
         * Realtek video vga resolution setting.
         * This is an integer for video vga resolution.
         ...
         */
        public static final String REALTEK_SETUP_VIDEO_VGA_RESOLUTION = "realtek_setup_video_vga_resolution";

        /**
         * Realtek video output setting.
         * This is an integer for video output.
         ...
         * } ENUM_VIDEO_OUTPUT;
         */
        public static final String REALTEK_SETUP_VIDEO_OUTPUT = "realtek_setup_video_output";

        /**
         * Realtek device name setting.
         * This is a string for device name.
         */
        public static final String REALTEK_SETUP_DLNA_DMS_DEVICE_NAME = "realtek_setup_dlna_dms_device_name";

        /**
         * Realtek device UUID setting.
         * This is a string for device UUID.
         */
        public static final String REALTEK_SETUP_DLNA_DMS_DEVICE_UUID = "realtek_setup_dlna_dms_device_uuid";

        /**
         * Whether DLNA DMR Mode is on.
         */
        public static final String REALTEK_SETUP_DLNA_DMR_MODE_ON = "realtek_setup_dlna_dmr_mode_on";

        /**
         * Whether Samba Server Mode is on.
         */
        public static final String REALTEK_SETUP_SAMBA_SERVER_MODE_ON = "realtek_setup_samba_server_mode_on";

        /**
         * Playback effect mode.
		 * This is a string for playback effect.
		 * off : OFF
		 * night : Night Mode.
		 * comfort : Comfort Mode.
         */
        public static final String REALTEK_SETUP_PLAYBACK_EFFECT_MODE = "realtek_setup_playback_effect_mode";

        /**
         * Realtek SoftAP WPS Method setting.
         * This is a string for softap wps method.
		 * sw_pbc: SW PBC
		 * pin_code: Pin Code
         */
        public static final String REALTEK_SETUP_SOFTAP_WPS_METHOD = "realtek_setup_softap_wps_method";

        /**
         * IRDA/CEC switch
         * This is a string to store IRDA/CEC switch mode.
		 * off : OFF
		 * cec : CEC
		 * irda : IRDA
         */
        public static final String REALTEK_SETUP_IRDA_CEC_SWITCH = "realtek_setup_irda_cec_switch";

        /**
         * Whether Screen Zoom Mode is on.
         */
        public static final String REALTEK_SETUP_SCREEN_ZOOM_ON = "realtek_setup_screen_zoom_on";

        /**
         * Whether the user have the amplifier.
         */
        public static final String REALTEK_SETUP_USER_HAVE_AMPLIFIER_ON = "realtek_setup_user_have_amplifier_on";

        /**
         * Whether the user have the amplifier and support 5.1 ch output.
         */
        public static final String REALTEK_SETUP_USER_HAVE_AMPLIFIER_51CH_OUTPUT_ON = "realtek_setup_user_have_amplifier_51ch_output_on";

        /**
         * Whether the user have the amplifier and support 7.1 ch output.
         */
        public static final String REALTEK_SETUP_USER_HAVE_AMPLIFIER_71CH_OUTPUT_ON = "realtek_setup_user_have_amplifier_71ch_output_on";

        /**
         * Realtek HDMI output mode
         * This is a string to store HDMI output mode.
		 * off : OFF
		 * lpcm : LPCM
		 * mlpcm : Multi CH LPCM
		 * raw : RAW
         */
        public static final String REALTEK_SETUP_HDMI_OUTPUT_MODE = "realtek_setup_hdmi_ouput_mode";

        /**
         * Realtek SPDIF output mode
         * This is a string to store SPDIF output mode.
		 * off : OFF
		 * lpcm : LPCM
		 * raw : RAW
         */
        public static final String REALTEK_SETUP_SPDIF_OUTPUT_MODE = "realtek_setup_spdif_ouput_mode";

        /**
         * Realtek text encoding
         * This is a string to store text encoding.
		 * off : OFF
		 * utf8 : UTF8
		 * big5 : BIG5
		 * ...etc
         */
        public static final String REALTEK_SETUP_TEXT_ENCODING_MODE = "realtek_setup_text_encoding_mode";

        /**
         * Realtek file upload path
         * This is a string to store path that the CGI will put the file.
         */
        public static final String REALTEK_SETUP_CGI_UPLOAD_FILE_PATH = "realtek_setup_cgi_upload_file_path";

	/**
	   * Realtek Miracast Sink On/Off
	   * This is a string to store on/off of Miracast Sink
	   */
	  public static final String REALTEK_SETUP_MIRACAST_SINK_TOGGLE_ON = "realtek_setup_miracast_sink_toggle_on";

	/**
	   * Realtek Miracast Sink Connection Reminder On/off
	   * This is a string to store on/off of Miracast Sink connection reminder for non-persistent connection
	   */
	  public static final String REALTEK_SETUP_MIRACAST_SINK_CONNECTION_REMINDER_ON = "realtek_setup_miracast_sink_connection_reminder_on";

	/**
	   * Realtek Miracast Sink PIN code
	   * This is a string to store the PIN code (for other APP to query PIN code)
	   */
	  public static final String REALTEK_SETUP_MIRACAST_SINK_PIN_CODE = "realtek_setup_miracast_sink_pin_code";


        /**
           * Realtek to note if the device name already update by User
           */
        public static final String REALTEK_IS_DEVICE_NAME_CHANGED_BY_USER  = "realtek_is_device_name_changed_by_user";

        /**
           * Realtek to note the Wifi Mac is ready
           */        
        public static final String REALTEK_IS_WIFI_MACADDR_READY  = "realtek_is_wifi_macAddr_ready";

        /**
           * Realtek to define the device name
           */            
        public static final String REALTEK_DEFAULT_DEVICE_NAME  = "realtek_def_deivce_name";

        /**
         * Realtek Deep Color mode: AUTO, 12Bit, 10Bit, OFF
         */
        public static final String REALTEK_DEEP_COLOR_MODE = "realtek_deep_color_mode";

        /**
         * Realtek player depends on this setting to determine whether ignore HDMI plug-out signal or not.
         */
        public static final String REALTEK_IGNORE_HDMI_PLUGOUT = "realtek_ignore_hdmi_plugout";

        /**
         *  Auto switch TV system to 1080p 24Hz or not.
         */
        public static final String REALTEK_SETUP_AUTO_1080P24 = "realtek_setup_auto_1080p24";

        /**
         *  YST Mode: List all TV systems.
         */
        public static final String REALTEK_YST_MODE = "realtek_yst_mode";

        /**
         *  Auto switch TV system to 29.97/59.94Hz or not.
         */
        public static final String REALTEK_SETUP_AUTO_2997HZ = "realtek_setup_auto_2997hz";

        /**
         *  Force Audio output to SD Audio
         */
        public static final String REALTEK_SETUP_FORCE_SDAUDIO = "realtek_setup_force_sdaudio";

        /**
         *  Force Use RTMediaPlayer
         */
        public static final String REALTEK_FORCE_RT_MEDIAPLAYER = "realtek_force_rt_mediaplayer";
        ...
        public static final String[] SETTINGS_TO_BACKUP = {
			...
			REALTEK_SETUP_TV_SYSTEM,
			REALTEK_SETUP_TV_STANDARD,
			REALTEK_SETUP_REAL_TV_SYSTEM,
			REALTEK_SETUP_TV_SYSTEM_USER,
			REALTEK_SETUP_ASPECT_RATIO,
			REALTEK_SETUP_CURRENT_HDMI_TV_VID,
			REALTEK_SETUP_TV_SYSTEM_AUTO_MODE,
			REALTEK_SETUP_TV_SYSTEM_MANUAL,
			REALTEK_SETUP_TV_STANDARD_MANUAL,
			REALTEK_SETUP_VIDEO_VGA_RESOLUTION,
			REALTEK_SETUP_VIDEO_OUTPUT,
			REALTEK_SETUP_DLNA_DMS_DEVICE_NAME,
			REALTEK_SETUP_DLNA_DMS_DEVICE_UUID,
			REALTEK_SETUP_PLAYBACK_EFFECT_MODE,
			REALTEK_SETUP_SOFTAP_WPS_METHOD,
			REALTEK_SETUP_MIRACAST_SINK_TOGGLE_ON,
			REALTEK_SETUP_MIRACAST_SINK_CONNECTION_REMINDER_ON,
            REALTEK_DEEP_COLOR_MODE,
            REALTEK_IGNORE_HDMI_PLUGOUT,
			REALTEK_SETUP_MIRACAST_SINK_PIN_CODE,
			REALTEK_IS_DEVICE_NAME_CHANGED_BY_USER,
			REALTEK_IS_WIFI_MACADDR_READY,
			REALTEK_DEFAULT_DEVICE_NAME,
			REALTEK_SETUP_AUTO_1080P24,
            REALTEK_YST_MODE,
            REALTEK_SETUP_AUTO_2997HZ,
            REALTEK_SETUP_FORCE_SDAUDIO
        };
    ...
    public static final class Global extends NameValueTable {
		...
		public static final String WEBSERVER_MODE_ON = "webserver_mode_on";
        ...
        * @hide
        */
       public static final String HDMI_CEC_POWER_ON_FROM_TV =
               "hdmi_cec_power_on_from_tv";
       ...
       public static final String WIFI_P2P_DEVICE_NAME = "wifi_p2p_device_name";
        ...
        public static final String PPPOE_ISSET      = "pppoe_isSet";  

...
public class RecoverySystem {
    ...
    public static void installPackage(Context context, File packageFile, boolean processed)
        ...
        synchronized (sRequestLock) {
            ...
            //rtk begin
            // write string for update_package depending on different source
            // /cache/update.zip   => from OTA
            // /usb/update.zip     => from USB
            // /sdcard/update.zip  => from SDCARD
            // /unknown/update.zip => from Unknown source, ignore.
            if(filename.contains(new String("/cache/")) == true) {
                filename = filename.replace("/cache/","CACHE:");
            } else if(filename.contains(new String("/usb/")) == true) {
                filename = "USB:" + packageFile.getName();
            } else if(filename.contains(new String("/sdcard/")) == true) {
                filename = "SDCARD:" + packageFile.getName();
            }
            //rtk end

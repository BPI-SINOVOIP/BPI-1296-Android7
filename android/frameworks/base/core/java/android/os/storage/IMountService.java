...
public interface IMountService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMountService {
        private static class Proxy implements IMountService {
            ...
            //[RTK Begin]
            /*
            public StorageVolume[] getMountedVolumeList() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                StorageVolume[] _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    mRemote.transact(Stub.TRANSACTION_getMountedVolumeList, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.createTypedArray(StorageVolume.CREATOR);
                } finally {
                    _reply.recycle();
        ...
        //[RTK Begin]
        //static final int TRANSACTION_getMountedVolumeList = IBinder.FIRST_CALL_TRANSACTION + 43;
        //[RTK End]
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply,
            ...
            switch (code) {
                ...
                //[RTK Begin]
                /*
                case TRANSACTION_getMountedVolumeList: {
                    data.enforceInterface(DESCRIPTOR);
                    StorageVolume[] result = getMountedVolumeList();
                    reply.writeNoException();
                    reply.writeTypedArray(result, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
                    return true;
                }

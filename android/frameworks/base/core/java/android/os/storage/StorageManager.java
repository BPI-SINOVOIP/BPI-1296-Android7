...
public class StorageManager {
    ...
    //[RTK Begin]
    /**
     * Return list of all mounted volumes.
     * @hide
     */
    /*
    public StorageVolume[] getMountedVolumeList() {
        if (mMountService == null) return new StorageVolume[0];
        try {
            Parcelable[] list = mMountService.getMountedVolumeList();
            ...
            Log.e(TAG, "Failed to get mounted volume list", e);
            return null;
        }
    }
    */
    ...
    /**
     * Return list of paths for all mounted volumes.
     * @hide
     */
    /*
    public String[] getMountedVolumnPaths() {
        StorageVolume[] volumes = getMountedVolumeList();
    ...
    */
    ...
    /** {@hide} */
    public StorageVolume getVolume(String mountPoint) {
        StorageVolume[] volumes = getVolumeList();
        if (volumes == null) {
            Log.w(TAG, "volume list is empty");
            return null;
        }
        for (StorageVolume volume : volumes) {
        ...
        Log.w(TAG, "no such volume defined");
        return null;
    }
    //[RTK End]

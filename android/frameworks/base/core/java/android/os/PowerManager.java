...
public final class PowerManager {
    ...
    /**
     * Wake lock level: special wake lock used for realtek modules
     */
    public static final int RTK_WAKE_LOCK  = 0x00000200;

    /**
     * Wake lock level: special wake lock used for RTK modules, this lock can totally prevent system entering suspend
     */
    public static final int RTK_STRONG_WAKE_LOCK  = 0x00000400;

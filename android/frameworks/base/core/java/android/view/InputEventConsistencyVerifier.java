                ...
                switch (action) {
                    ...
                    default: {
                        ...
                        if (actionMasked == MotionEvent.ACTION_POINTER_DOWN) {
                            ...
                            ensureHistorySizeIsZeroForThisAction(event);
                        }else if (actionMasked == MotionEvent.ACTION_HOVER_MOVE) { //RTK: avoid output too many msgs on mouse moving
                            mTouchEventStreamIsTainted = false;
                            Log.d(mLogTag, "Invalid action " + MotionEvent.actionToString(action)
                                    + " for touch event.");
                        } else {
                            problem("Invalid action " + MotionEvent.actionToString(action)
                                    + " for touch event.");

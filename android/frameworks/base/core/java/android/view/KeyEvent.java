...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    /** Key code constant: media repeat key
     * Set playback repeat. */
    public static final int KEYCODE_MEDIA_REPEAT    = 284;

    private static final int LAST_KEYCODE = KEYCODE_MEDIA_REPEAT;
    ...
    private static void populateKeycodeSymbolicNames() {
        ...
        names.append(KEYCODE_MEDIA_REPEAT, "KEYCODE_MEDIA_REPEAT");
    };
    ...
    public static final int META_3DMODE_SBS = 0x1000000;
    public static final int META_3DMODE_TB = 0x2000000;
    ...
    private static final int META_3DMODE_MASK =
            META_3DMODE_SBS | META_3DMODE_TB;

    // Mask of all valid meta states.
    private static final int META_ALL_MASK = META_MODIFIER_MASK | META_LOCK_MASK | META_3DMODE_MASK;

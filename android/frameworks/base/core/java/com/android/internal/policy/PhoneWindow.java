...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    private final static String BT_VOICE_PROPERTY = "persist.rtk.bt.voice";
    private final static String VOICE_BEE1 = "bee1";
    private final static String VOICE_BEE2 = "bee2";
    ...
    protected boolean onKeyDown(int featureId, int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_SEARCH: {  // mhwu
                String voice = SystemProperties.get(BT_VOICE_PROPERTY, VOICE_BEE2);
                if(voice.equals(VOICE_BEE2))
                    break;

                Log.d(TAG, "On search key down with " + voice);
                if (event.getRepeatCount() == 0) {
    ...
    protected boolean onKeyUp(int featureId, int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_SEARCH: {
                 ...
                 */
              String voice = SystemProperties.get(BT_VOICE_PROPERTY, VOICE_BEE2);
              if(voice.equals(VOICE_BEE2)){ //mhwu
                Log.d(TAG, "On search key up with " + voice);

...
static jint
android_media_AudioSystem_setHDMIRXstate(JNIEnv *env, jobject clazz, jboolean state)
{
    return (jint) AudioSystem::setHDMIRXstate((bool) state);
}
...
static const JNINativeMethod gMethods[] = {
    ...
    {"setHDMIRXstate",      "(Z)I",     (void *)android_media_AudioSystem_setHDMIRXstate},

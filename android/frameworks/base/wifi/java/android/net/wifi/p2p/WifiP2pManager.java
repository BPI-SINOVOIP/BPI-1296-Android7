...
public class WifiP2pManager {
    ...
    /** RTK CUSOM */
    public static final int LISTEN_PEERS                            = BASE + 74;
    ...
    /** RTK CUSOM */
    public static final int LISTEN_PEERS_AUTO                       = BASE + 82;
    /**
   ...
   public interface DnsSdTxtRecordListener {
    ...
    public void ListenPeers(Channel c, ActionListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(LISTEN_PEERS, 0, c.putListener(listener));
    }

   public void ListenPeersAuto(Channel c, ActionListener listener) {
       checkChannel(c);
       c.mAsyncChannel.sendMessage(LISTEN_PEERS_AUTO, 0, c.putListener(listener));
   }
   ...
   /**
    ...
    public void setMiracastMode_AP(int mode) {
        try {
            mService.setMiracastMode_AP(mode);
        } catch(RemoteException e) {
           // ignore
        }
    }

...
#ifdef _ANDROID
#ifndef LOG_TAG
#define LOG_TAG "UPNP3"
#endif
#include <cutils/log.h>
#define ULOGD(fmt,args...)  ALOGD(fmt, ##args)
#define ULOGE(fmt,args...)  ALOGE(fmt, ##args)
#define ULOGV(fmt,args...)  ALOGV(fmt, ##args)
#else
#include "rDebug.h"
#define ULOGD(fmt,args...)  rDebug(fmt"\n", ##args)
#define ULOGE(fmt,args...)  rError(fmt"\n", ##args)
#define ULOGV(fmt,args...)  rTrace(fmt, ##args)
#endif

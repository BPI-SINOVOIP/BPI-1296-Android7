...
#define EVENT_ALL_RENDERINGCONTROL              (EVENT_CONTRAST|EVENT_BRIGHTNESS|EVENT_VOLUME|EVENT_MUTE|EVENT_PRESETNAMELIST)
...
{
	ULOGV("Invoke: DMR_ConnectionManager_GetCurrentConnectionIDs();");
...
void DMR_ConnectionManager_GetCurrentConnectionInfo(DMR_SessionToken upnptoken, int ConnectionID)
{
    ...
    ULOGV("Invoke: DMR_ConnectionManager_GetCurrentConnectionInfo(%d);",ConnectionID);
...
void DMR_ConnectionManager_GetProtocolInfo(DMR_SessionToken upnptoken)
{
    ...
    ULOGV("Invoke: DMR_ConnectionManager_GetProtocolInfo();");
...
void DMR_AVTransport_GetCurrentTransportActions(DMR_SessionToken upnptoken,unsigned int InstanceID)
{
	...
	ULOGV("Invoke: DMR_AVTransport_GetCurrentTransportActions(%u);",InstanceID);
...
void DMR_AVTransport_GetDeviceCapabilities(DMR_SessionToken upnptoken,unsigned int InstanceID)
{
    ...
    ULOGV("Invoke: DMR_AVTransport_GetDeviceCapabilities(%u);",InstanceID);
...
#if defined(PPTV) && !defined(DLNADMRCTT)
...
void DMR_AVTransport_GetMediaInfo(DMR_SessionToken upnptoken,unsigned int InstanceID)
{
	...
	ULOGV("Invoke: DMR_AVTransport_GetMediaInfo(%u);", InstanceID);
...
void DMR_AVTransport_GetPositionInfo(DMR_SessionToken upnptoken,unsigned int InstanceID)
{
	...
	ULOGV("Invoke: DMR_AVTransport_GetPositionInfo(%u);",InstanceID);
	...
	ULOGD("relTime=%s absTime=%s CurrentTrackDuration=%s",relTime,absTime,trackDuration);
...
void DMR_AVTransport_GetTransportInfo(DMR_SessionToken upnptoken,unsigned int InstanceID)
{
    ...
    ULOGV("Invoke: DMR_AVTransport_GetTransportInfo(%u);", InstanceID);
	...
	ULOGD("transportState=%s transportStatus=%s transportSpeed=%s", transportState, transportStatus, transportSpeed);
...
void DMR_AVTransport_GetTransportSettings(DMR_SessionToken upnptoken,unsigned int InstanceID)
{
    ...
    ULOGV("Invoke: DMR_AVTransport_GetTransportSettings(%u);",InstanceID);
...
void DMR_AVTransport_Next(DMR_SessionToken upnptoken,unsigned int InstanceID)
{
	...
	ULOGV("Invoke: DMR_AVTransport_Next(%u);",InstanceID);
...
void DMR_AVTransport_Pause(DMR_SessionToken upnptoken,unsigned int InstanceID)
{
	...
	ULOGV("Invoke: DMR_AVTransport_Pause(%u);",InstanceID);
...
void DMR_AVTransport_Play(DMR_SessionToken upnptoken,unsigned int InstanceID,char* Speed)
{
	...
	ULOGV("Invoke: DMR_AVTransport_Play(%u,%s);",InstanceID,Speed);
...
void DMR_AVTransport_Previous(DMR_SessionToken upnptoken,unsigned int InstanceID)
{
	...
	ULOGV("Invoke: DMR_AVTransport_Previous(%u);",InstanceID);
...
void DMR_AVTransport_Seek(DMR_SessionToken upnptoken,unsigned int InstanceID,char* Unit,char* Target)
{
    ...
    ULOGV("Invoke: DMR_AVTransport_Seek(%u,%s,%s);", InstanceID, Unit, Target);
    ...
    if(strcmp(Unit, "TRACK_NR") == 0)
    {
        ...
        _addMethodParameter(method, (METHOD_PARAM)(unsigned long)target);
...
void DMR_AVTransport_SetAVTransportURI(DMR_SessionToken upnptoken, unsigned int InstanceID, char* CurrentURI, char* CurrentURIMetaData)
{
	...
	ULOGV("Invoke: DMR_AVTransport_SetAVTransportURI(%u,%s,%s);", InstanceID, CurrentURI, CurrentURIMetaData);
...
void DMR_AVTransport_SetNextAVTransportURI(DMR_SessionToken upnptoken, unsigned int InstanceID, char* NextURI, char* NextURIMetaData)
{
	...
	ULOGV("Invoke: DMR_AVTransport_SetNextAVTransportURI(%u,%s,%s);", InstanceID, NextURI, NextURIMetaData);
...
void DMR_AVTransport_SetPlayMode(DMR_SessionToken upnptoken,unsigned int InstanceID,char* NewPlayMode)
{
	...
	ULOGV("Invoke: DMR_AVTransport_SetPlayMode(%u,%s);",InstanceID,NewPlayMode);
...
void DMR_AVTransport_Stop(DMR_SessionToken upnptoken,unsigned int InstanceID)
{
	...
	ULOGV("Invoke: DMR_AVTransport_Stop(%u);",InstanceID);
...
void DMR_RenderingControl_ListPresets(DMR_SessionToken upnptoken, unsigned int InstanceID)
{
	...
	ULOGV("Invoke: DMR_RenderingControl_ListPresets(%u);",InstanceID);
...
void DMR_RenderingControl_SelectPreset(DMR_SessionToken upnptoken, unsigned int InstanceID, char* PresetName)
{
	...
	ULOGV("Invoke: DMR_RenderingControl_SelectPreset(%u,%s);", InstanceID, PresetName);
...
void DMR_RenderingControl_GetBrightness(DMR_SessionToken upnptoken, unsigned int InstanceID)
{
    ...
    ULOGV("Invoke: DMR_RenderingControl_GetBrightness(%u);", InstanceID);
...
void DMR_RenderingControl_GetContrast(DMR_SessionToken upnptoken,unsigned int InstanceID)
{
	...
	ULOGV("Invoke: DMR_RenderingControl_GetContrast(%u);", InstanceID);
...
void DMR_RenderingControl_SetBrightness(DMR_SessionToken upnptoken, unsigned int InstanceID, unsigned short DesiredBrightness)
{
	...
	ULOGV("Invoke: DMR_RenderingControl_SetBrightness(%u,%u);", InstanceID, DesiredBrightness);
...
void DMR_RenderingControl_SetContrast(DMR_SessionToken upnptoken, unsigned int InstanceID, unsigned short DesiredContrast)
{
	...
	ULOGV("Invoke: DMR_RenderingControl_SetContrast(%u,%u);", InstanceID, DesiredContrast);
...
void DMR_RenderingControl_GetMute(DMR_SessionToken upnptoken, unsigned int InstanceID, char* Channel)
{
	...
	ULOGV("Invoke: DMR_RenderingControl_GetMute(%u,%s);",InstanceID,Channel);
...
void DMR_RenderingControl_GetVolume(DMR_SessionToken upnptoken, unsigned int InstanceID, char* Channel)
{
	...
	ULOGV("Invoke: DMR_RenderingControl_GetVolume(%u,%s);", InstanceID, Channel);
...
void DMR_RenderingControl_SetMute(DMR_SessionToken upnptoken,unsigned int InstanceID,char* Channel,int DesiredMute)
{
    ...
    ULOGV("Invoke: DMR_RenderingControl_SetMute(%u,%s,%d);", InstanceID, Channel, DesiredMute);
    ...
    _addMethodParameter(method, (METHOD_PARAM)(unsigned long)DesiredMute);
...
void DMR_RenderingControl_SetVolume(DMR_SessionToken upnptoken,unsigned int InstanceID,char* Channel,unsigned short DesiredVolume)
{
    ...
    _addMethodParameter(method, (METHOD_PARAM)(unsigned long)DesiredVolume);
...
DMR DMR_Method_Create(void* chain, unsigned short port, char* friendlyName, char* serialNumber, char* UDN, char* protocolInfo, ILibThreadPool threadPool)
{
	...
	/* Add the handle for special characters */
	char strFriendlyName[1024];
	ILibXmlEscape(strFriendlyName, friendlyName);

    /* Set the default values for the DMR_InternalState. */
    state->FriendlyName = String_Create(strFriendlyName);
...
char* GetTransportActions(unsigned short actions)
{
	...
	if(TESTBIT(lActions, (unsigned long)DMR_ATS_Play) == TRUE)
	{
		...
		#ifdef DLNADMRCTT
		if(DLNADMR_bPlayingAV)
		strcat(result, ",X_DLNA_PS=-2\\,-1\\,1\\,4");
		#endif
	}
	if(TESTBIT(lActions, (unsigned long)DMR_ATS_Stop) == TRUE)
	{
	...
	if(TESTBIT(lActions, (unsigned long)DMR_ATS_Seek) == TRUE)
	{
		...
		strcat(result, "Seek,X_DLNA_SeekTime");
	}
...
void DMR_LastChangeUpdateImmediate(void *object)
{
	...
	{
		ULOGD("Will  not call FireGenaLastChangeEvent");
	}
}
...
void FireGenaLastChangeEvent(DMR instance)
{
    ...
    if ((state->LastChangeMask & EVENT_ALL_RENDERINGCONTROL) != 0)
    { /* RenderingControl */
    ...
    /* ^^^ Added by yuyu for DLNA 1.5 CTT 7.3.93.1 ^^^ */
		...
		ULOGD("RenderingControl: Gena Event [0x%x] Fired!", state->LastChangeMask);
        free(renderingData);
    }

	if ((state->LastChangeMask & EVENT_ALL_AVTRANSPORT) != 0)
    { /* AVTransport */
    ...
    /* ^^^ Added by yuyu for DLNA 1.5 CTT 7.3.93.1 ^^^ */
        ...
        strcat(AVTransportData, "</InstanceID></Event>");
		{
			...
			{
				ULOGE("FATAL MEMORY ERROR!");
			}
		}
        DMR_SetState_AVTransport_LastChange(state->DMR_microStack, AVTransportData);
		ULOGD("AVTransport: Gena Event [0x%x] Fired!", state->LastChangeMask);
...
DMR_Error DMR_StateChange_TransportPlayState(DMR instance, DMR_PlayState state)
{
    ...
    DMR_Unlock(instance);
		...
		if(state == DMR_PS_Paused)
	       DMR_StateChange_UpdateCurrentTransportActions(instance, 0, DMR_ATS_Pause);
		else
	       DMR_StateChange_UpdateCurrentTransportActions(instance, DMR_ATS_Pause, 0);
	#else
		if(state == DMR_PS_Playing)
			DMR_StateChange_UpdateCurrentTransportActions(instance,0 ,DMR_ATS_Play);
		else
			DMR_StateChange_UpdateCurrentTransportActions(instance, DMR_ATS_Play, 0);
	#endif
...
DMR_Error DMR_StateChange_CurrentTransportActions(DMR instance, unsigned short allowedActions)
{
    ...
    ULOGV("DMR_StateChange_CurrentTransportActions [%x] -> [%x]", istate->CurrentTransportActions, allowedActions);
...
DMR_Error DMR_StateChange_CurrentTrackDuration(DMR instance, long duration)
{
    ...
    if(istate->CurrentTrackDuration != duration)
    {
		...
		ULOGD("Duration changed CurrentTrackDuration=%d",duration);
        ...
        case DMR_ECS_SETVOLUME:
            {
                ...
                {
                    int result;
                    unsigned char val = (unsigned char)(unsigned long)method->parameters[0];
        ...
        case DMR_ECS_SETMUTE:
            {
                ...
                {
                    int result;
                    BOOL val = (BOOL)(unsigned long)method->parameters[0];
...
DMR_Error DMR_StateChange_UpdateCurrentTransportActions(DMR instance, unsigned short addedActions, unsigned short removedActions)
{
    DMR_InternalState istate = (DMR_InternalState)instance->internal_state;
    DMR_Error err = CheckThis(instance);
    if(err != DMR_ERROR_OK)
    ...
    DMR_Lock(instance);
   	unsigned short newActions = istate->CurrentTransportActions;
   	newActions |= addedActions;
   	newActions &= ~removedActions;
    DMR_Unlock(instance);

    return DMR_StateChange_CurrentTransportActions(instance, newActions);
}

DMR_Error DMR_StateChange_Reset(DMR instance)
{
    DMR_InternalState istate = (DMR_InternalState)instance->internal_state;
    DMR_Error err = CheckThis(instance);
    if(err != DMR_ERROR_OK)
    ...
    istate->TransportState = DMR_PS_Stopped;
    istate->CurrentMediaDuration = 0;
    istate->CurrentTrackDuration = 0;
    istate->AbsoluteTimePosition = 0;
    istate->RelativeTimePosition = 0;
    istate->NumberOfTracks       = 0;
    istate->CurrentTrack         = 0;
    istate->LastChangeMask = 0;
...
DMR_Error DMR_StateChange_ResetLastChangeMask(DMR instance, BOOL bReset)
{
    DMR_InternalState istate = (DMR_InternalState)instance->internal_state;
    DMR_Error err = CheckThis(instance);
    if(err != DMR_ERROR_OK)
    ...
    DMR_Lock(instance);
   	...
   	istate->LastChangeMask = bReset ? 0 : EVENT_MASK_RENDERINGCONTROL|EVENT_MASK_AVTRANSPORT;
...
#ifdef DLNADMRCTT
void DMR_Set_PlayingAV(int value)
{
    DLNADMR_bPlayingAV = value;
}
#endif

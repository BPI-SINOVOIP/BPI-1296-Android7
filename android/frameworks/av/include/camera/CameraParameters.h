...
public:
...
#if 1
    void compare(const CameraParameters &origParams) const;
    bool changed(const CameraParameters &origParams, const char *key) const;
#endif
    /**
...
#if 1
    // Preview enabled
    static const char KEY_PREVIEW_ENABLED[];
#endif
	...
	static const char PIXEL_FORMAT_H264[];	// H264

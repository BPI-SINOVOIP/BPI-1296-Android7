...
//rtk begin
    virtual status_t setRTKAudioActive(bool state) = 0;
    virtual bool isRTKAudioActive() = 0;
//rtk end
    virtual status_t setHDMIRXstate(bool state) = 0;
    virtual status_t setHDMIRXvolume(int volume) = 0;

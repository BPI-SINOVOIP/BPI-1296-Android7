...
enum media_info_type {
    ...
    MEDIA_INFO_DOMAIN_UPDATE = 804,
    MEDIA_INFO_TITLE_UPDATE = 805,
    MEDIA_INFO_CHAPTER_UPDATE = 806,
    ...
    * APK the event via MEDIA_INFO insteaf of MEDIA_ERROR */
    MEDIA_INFO_AUDIO_FATAL_ERROR = 807,
    // --- RTK
...
enum media_player_invoke_ids {
    ...
    INVOKE_ID_SET_TV_SYSTEM_TYPE = 8,
    INVOKE_ID_SET_LANGUAGES = 9,
    INVOKE_ID_SET_GET_NAV_PROPERTY = 10,
    INVOKE_ID_EXEC_BOOKMARK_OPERATION = 11,
    INVOKE_ID_EXEC_SUBTITLE_OPERATION = 12,
    INVOKE_ID_EXEC_AUDIO_OPERATION = 13,
    INVOKE_ID_SET_VIDEO_SCALED_SIZE = 14,
};
...
enum force_media_player_type {
    FORCE_NONE = 0,
    FORCE_ANDROID_MEDIAPLAYER = 1,
    FORCE_RT_MEDIAPLAYER = 2,
    FORCE_BY_SCORE = 3,
};
...
public:
    ...
    ~MediaPlayer();
            ...
            status_t        getPlayerCurrentState(int *pstate);
            int             *getAudioTrackInfo(int streamNum);
            status_t        setAudioTrackInfo(int streamNum);
            status_t        execSetGetNavProperty(int propertyID,unsigned char *ucpInput,int inDataSize,unsigned char **outData,int *outDataSize);
            ...
            status_t        setOutputFormat(int outputType,
                                        ...
                                        int udpPort,
                                        bool rtpHeader);
            // status_t        configureTargetFormat(AV_FORMAT_CONFIG &targetFmt);
...
private:
    ...
    unsigned char*              m_psSetGetNavVirAddr;
    int                         mForceUseRTMediaPlayer;
#endif // USE_RT_MEDIA_PLAYER
};

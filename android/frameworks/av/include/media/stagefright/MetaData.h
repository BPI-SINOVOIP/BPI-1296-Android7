...
enum {
    ...
    kKeyAudioBitsPerSample = 'ABPS',  // int32_t (audio sample size)
    ...
    kKeyPrivateInfo       = 'info',  // raw data (RTK privateInfo)
    kKeyRTKExtr           = 'extr',  // RTK extractor (RTK extractor)
    kKeySetBSRingfd       = 'sbsf',  // RTK BSRingBuffer share fd
    kKeyVideoLowDelay     = 'vldm',  // int32_t, RTK video low delay mode used
	kKeyVideoSearchIFrame = 'vsif',  // int32_t, RTK OMX Video component enable search I frame when playback or after seek
    kKeyAACProfile        = 'aacp',  // int32_t
    kKeyAVCC              = 'avcc',  // raw data
    kKeyHVCC              = 'hvcc',  // raw data
    kKeyD263              = 'd263',  // raw data
    kKeyVorbisInfo        = 'vinf',  // raw data
    kKeyVorbisComment     = 'vcom',  // raw data
...
#if 1
    kKeyInitialReadTime   = 'irdt',  // int64_t (usecs)
#endif
    ...
    kKeyALAC_CAFFConfig        = 'alcf',  // pointer
#endif
    kKeyWVC1              = 'wvc1',  // wvc1 codec specific data
    ...
    kKeyDSDChannelType = 'DChT', // int32_t (DSD audio Channel Type)
    kKeyDSDSampleCount = '#DSC', // uint64_t (DSD audio Sample count)
    kKeyDSDBlockSize = 'DBSC', // int32_t (DSD Block size per channel)
    kKeyFrameRateFloat  = 'frRF',  // float (video frame rate fps)
    kKeyIsMVC             = 'cMVC', //int32_t (3D MVC)
    kKeyRows      = 'rowS', //int32_t data
    kKeyColumns      = 'clmS', //int32_t data
    kKeyOutputWidth      = 'outW', //int32_t data
    kKeyOutputHeight      = 'outH' //int32_t data
};

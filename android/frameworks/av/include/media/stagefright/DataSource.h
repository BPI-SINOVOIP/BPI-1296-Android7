...
public:
    ...
    bool sniffRTKHLS(String8 *mimeType, float *confidence, sp<AMessage> *meta);
    ...
    virtual int getfd(void){ return 0;}
    virtual void *getPointer (void) {return mPointer; }
    virtual void setPointer(void * sPointer) {mPointer = sPointer; }

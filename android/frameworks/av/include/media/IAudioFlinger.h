...
public:
    ...
    virtual uint32_t getInputLatency(audio_io_handle_t ioHandle) const = 0;

    virtual int64_t getInputTimeStamp(audio_io_handle_t ioHandle) const = 0;
...
//rtk begin
    virtual     uint32_t    fwlatency(audio_io_handle_t output) const = 0;
//rtk end
};

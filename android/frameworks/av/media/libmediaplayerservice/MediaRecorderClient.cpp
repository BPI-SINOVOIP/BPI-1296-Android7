...
#ifdef RTK_ENHANCE
status_t MediaRecorderClient::setOutputBuffer(const sp<IMemory> &bufferData, const sp<IMemory> &bufferInfo)
{
    ...
    return mRecorder->setOutputBuffer(bufferData, bufferInfo);
}
#endif
}; // namespace android

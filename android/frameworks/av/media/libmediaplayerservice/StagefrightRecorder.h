...
private:
    ...
    bool    mEnableStoreMetaDataInBuffers;
    bool    mPreferSoftwareCodec;
...
#ifdef RTK_ENHANCE
    status_t setParamMuxerUdpIp(String8 udpIp);
    status_t setParamMuxerUdpPort(int32_t udpPort);
    status_t setParamMuxerRtpOption(bool rtpOption);
    status_t setParamMuxerOutputType(int32_t outputType);
    status_t setParamVideoInputFormat(int32_t inputFormat);
    status_t setParamVideoStoreMetaDataInBuffers(bool storeMetaDataInBuffers);
    status_t setParamVideoPreferSoftwareCodec(bool preferSoftwareCodec);
#endif

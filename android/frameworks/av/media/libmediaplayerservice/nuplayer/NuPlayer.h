...
struct NuPlayer : public AHandler {
    ...
    void setResetFlgForAsyncFlw(bool flags);
    void setmIsNetAsyncFlw(bool flags);
    bool chkmIsNetAsyncFlw();
#endif
#ifdef RTK_PLATFORM
    bool chkIsLiveFlw();
#endif
...
#if defined (RTK_PLATFORM) && defined (RTK_NET_ASYNC_PLAYBACK_FLOW)
    void setDataSourceAsyncHttpCheck(
            const sp<IMediaHTTPService> &httpService,
            const char *url,
            const KeyedVector<String8, String8> *headers);

    bool mAsyncIsResetFlg;
    bool mIsNetAsyncFlw;
#endif
#ifdef RTK_PLATFORM
    bool IsHTTPLiveData(const sp<IMediaHTTPService> &httpService,
            const char *url, const KeyedVector<String8, String8> *headers);
    pthread_t mThread;
    bool mTreadRun;
    static void *ThreadWrapper(void *);
    status_t threadFunc();
    bool mIsGetHTTPLiveData;
    bool mIsHTTPLiveData;
    AString mUri;
#ifdef RTK_NET_ASYNC_PLAYBACK_FLOW
    KeyedVector<String8, String8> *mHeaders;
#else
    const KeyedVector<String8, String8> *mHeaders;
#endif

    sp<IMediaHTTPService> mHttpService;
    bool mIsHttpFlw;
    bool mIsLiveFlw;
    int32_t mDecErrorCnt;
    int64_t mDecErrPrePosUs;
#endif

...
struct ATSParser : public RefBase {
...
#ifdef RTK_PLATFORM
    status_t isVideoSizeSuitable();
    void setDequeueState(bool needDequeuePES);
    bool getDequeueState();
    int64_t getMaxPTS();
    void setESSeeking();
    void setCreator(unsigned type);
    int64_t getBaseTime();
    void eraseOtherPrograms();
    void setEnableTimestamp(bool flag);
#endif
    enum SourceType {
        VIDEO = 0,
        AUDIO = 1,
    ...
    enum {
...
#ifdef RTK_PLATFORM
        STREAMTYPE_H265_CASE2           = 0x06,
#endif
        STREAMTYPE_MPEG2_AUDIO_ADTS     = 0x0f,
        STREAMTYPE_MPEG4_VIDEO          = 0x10,
        STREAMTYPE_AAC_LATM             = 0x11,
        STREAMTYPE_METADATA             = 0x15,
        STREAMTYPE_H264                 = 0x1b,
        STREAMTYPE_AVS                  = 0x42,
#ifdef RTK_PLATFORM
        STREAMTYPE_H265                 = 0x24,
        STREAMTYPE_H265_CASE3           = 0x27,
        STREAMTYPE_VC1                  = 0xea,
        STREAMTYPE_PCM                  = 0x80,
#endif
        ...
        STREAMTYPE_MPEG2_AUDIO_DTS      = 0x82,
        STREAMTYPE_LPCM_AC3             = 0x83,
        STREAMTYPE_LPCM_DD_EAC3         = 0x84,
        STREAMTYPE_DTS_HD1              = 0x85,
        STREAMTYPE_DTS_HD2              = 0x86,
        STREAMTYPE_LPCM_DD_EAC3_CASE2   = 0x87,
    };

#ifdef RTK_PLATFORM
    enum {
        SOURCE_FROM_M3U8        = 0x00,
        SOURCE_FROM_CACHED      = 0x01,
        SOURCE_FROM_LOCAL       = 0x02,
    };
#endif

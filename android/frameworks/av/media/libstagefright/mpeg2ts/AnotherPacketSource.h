...
#ifdef RTK_PLATFORM
    size_t getPendingBufferSize();
    size_t getCurBufferSize();
    void setBaseTimeUs(int64_t timeUs);
    void setDiscTimeUs(int64_t timeUs);
    bool isVideoSource();
    void checkInterpolationType(const char *mime);
#endif
protected:
...
#ifdef RTK_PLATFORM
    size_t mPendingBuffer;
    size_t mCurBufferSize;
    int64_t mBaseTime;
    bool mCalPTS;
#endif

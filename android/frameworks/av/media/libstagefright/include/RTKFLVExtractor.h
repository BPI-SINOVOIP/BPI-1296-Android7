...
#ifndef RTKFLV_EXTRACTOR_H_

#define RTKFLV_EXTRACTOR_H_
...
class RTKFLVLoadableExtractor : public MediaExtractor {
public:
    RTKFLVLoadableExtractor() {}
    virtual ~RTKFLVLoadableExtractor() {}
...
class RTKFLVExtractor : public MediaExtractor {
public:
    RTKFLVExtractor(const sp<DataSource> &source);
...
protected:
    virtual ~RTKFLVExtractor();

private:
    sp<DataSource> mDataSource;
    sp<RTKFLVLoadableExtractor> mImpl;

    RTKFLVExtractor(const RTKFLVExtractor &);
    RTKFLVExtractor &operator=(const RTKFLVExtractor &);
};

...
private:
    ...
    enum {
        kPageSize                       = 65536,
        kDefaultHighWaterThreshold      = 40 * 1024 * 1024,      /* RTK: 20M=> 10M=> 40M
                                                                  * Reduce the reserved memory range. */
        kDefaultLowWaterThreshold       = 6 * 1024 * 1024,       /* RTK:  4M=>  6M
                                                                  * Increase the LowWaterThreshold, for reconnect case. */

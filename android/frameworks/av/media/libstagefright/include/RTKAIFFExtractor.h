...
#ifndef RTKAIFF_EXTRACTOR_H_

#define RTKAIFF_EXTRACTOR_H_
...
class RTKAIFFLoadableExtractor : public MediaExtractor {
public:
    RTKAIFFLoadableExtractor() {}
    virtual ~RTKAIFFLoadableExtractor() {}
...
class RTKAIFFExtractor : public MediaExtractor {
public:
    RTKAIFFExtractor(const sp<DataSource> &source);
...
protected:
    virtual ~RTKAIFFExtractor();

private:
    sp<DataSource> mDataSource;
    sp<RTKAIFFLoadableExtractor> mImpl;

    RTKAIFFExtractor(const RTKAIFFExtractor &);
    RTKAIFFExtractor &operator=(const RTKAIFFExtractor &);
};

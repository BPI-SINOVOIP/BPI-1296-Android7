...
#ifndef RTKHEIF_EXTRACTOR_H_

#define RTKHEIF_EXTRACTOR_H_
...
class RTKHEIFLoadableExtractor : public MediaExtractor
{
public:
    RTKHEIFLoadableExtractor() {}
    virtual ~RTKHEIFLoadableExtractor() {}
...
class RTKHEIFExtractor : public MediaExtractor
{
public:
    RTKHEIFExtractor(const sp<DataSource> &source);
...
protected:
    virtual ~RTKHEIFExtractor();

private:
    sp<DataSource> mDataSource;
    sp<RTKHEIFLoadableExtractor> mImpl;

    RTKHEIFExtractor(const RTKHEIFExtractor &);
    RTKHEIFExtractor &operator=(const RTKHEIFExtractor &);
};

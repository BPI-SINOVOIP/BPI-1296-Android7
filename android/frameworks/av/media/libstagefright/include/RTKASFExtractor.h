...
#ifndef RTKASF_EXTRACTOR_H_

#define RTKASF_EXTRACTOR_H_
...
class RTKASFLoadableExtractor : public MediaExtractor {
public:
    RTKASFLoadableExtractor() {}
    virtual ~RTKASFLoadableExtractor() {}
...
class RTKASFExtractor : public MediaExtractor {
public:
    RTKASFExtractor(const sp<DataSource> &source);
...
protected:
    virtual ~RTKASFExtractor();

private:
    sp<DataSource> mDataSource;
    sp<RTKASFLoadableExtractor> mImpl;

    RTKASFExtractor(const RTKASFExtractor &);
    RTKASFExtractor &operator=(const RTKASFExtractor &);
};

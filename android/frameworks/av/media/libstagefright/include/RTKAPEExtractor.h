...
#ifndef RTKAPE_EXTRACTOR_H_

#define RTKAPE_EXTRACTOR_H_
...
class RTKAPELoadableExtractor : public MediaExtractor {
public:
    RTKAPELoadableExtractor() {}
    virtual ~RTKAPELoadableExtractor() {}
...
class RTKAPEExtractor : public MediaExtractor {
public:
    RTKAPEExtractor(const sp<DataSource> &source);
...
protected:
    virtual ~RTKAPEExtractor();

private:
    sp<DataSource> mDataSource;
    sp<RTKAPELoadableExtractor> mImpl;

    RTKAPEExtractor(const RTKAPEExtractor &);
    RTKAPEExtractor &operator=(const RTKAPEExtractor &);
};

...
#ifdef RTK_PLATFORM
#define RTK_PROPERTY_MEDIA_BUFFER  "rtk.media.video.buffersize"
#endif
...
struct LiveSession : public AHandler {
    ...
    sp<IMediaHTTPService> getHttphandle();
...
private:
...
#ifdef RTK_PLATFORM
    bool mInStartPlayBackFstChkBuffer;
    int64_t mOffsetTimeUs;

    struct BufInfoQueEntry
    {
        size_t up;
        size_t underflow;
        size_t down;
    ...
    bool mPreUnderflow;
    BufInfoQueEntry mBufInfoCnt;
    Vector<BufInfoQueEntry> mBufInfoQue;
    void QueueBufInfo(bool up, bool down, bool underflow);
    void QueueChkBufInfo(bool *up, bool *down, bool *underflow);

    ssize_t kHighWaterMarkBytes;
    void onRTKCustomerHighWaterMBsChk();

    int32_t mSwitchTimeoutCnt;
    int64_t mSwitchTime;
    bool mInSwitchPhase;
    bool mInSwitchPreparationPhase;
    void reconnectUri(int32_t dLineInfo);
#endif
    ...
    int64_t maudioTime;
    int64_t mvideoTime;
    int32_t maudioretryCount;
    int32_t mvideoretryCount;
...
#ifdef RTK_PLATFORM
    Mutex mDisLock;
    int32_t mLastSessionFlg;
    void setLastSessionFlg(int32_t dLastSessionFlg);
    ...
    {
        int64_t mTimeUs;
        int64_t mOriginalTimeUs;
        int32_t mCurSeqNumber;
        int64_t mPreTimeUs;
        int64_t mPreOriginalTimeUs;
        int32_t mPreSeqNumber;
        bool    mIsNeedRebase;
        int64_t mOffsetUs;
    };
    ...
    int32_t getSeqdstRebaseOffset(ssize_t streamIdx, ssize_t dstreamIdx);
#endif

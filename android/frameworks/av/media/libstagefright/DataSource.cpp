...
bool DataSource::sniffRTKHLS(
    ...
    *confidence = 0.0f;
    ...
    List<SnifferFunc>::iterator it = gSniffers.begin();
    String8 newMimeType;
    float newConfidence;
    sp<AMessage> newMeta;
    if ((*it)(this, &newMimeType, &newConfidence, &newMeta)) {
...
#ifdef USE_RTK_EXTRACTOR
    RegisterSniffer_l(SniffRTK);
#endif
#ifdef RTK_AUDIO_EXTRACTOR_EN
    RegisterSniffer_l(SniffRTKAudio);
#endif
    RegisterSniffer_l(SniffMPEG4);
//    RegisterSniffer_l(SniffFragmentedMP4);
    ...
    RegisterSniffer_l(SniffRTKASF);
    RegisterSniffer_l(SniffRTKAIFF);
    RegisterSniffer_l(SniffRTKFLV);
    RegisterSniffer_l(SniffRTKDSD);
    RegisterSniffer_l(SniffRTKAPE);
    RegisterSniffer_l(SniffRTKHEIF);
#endif

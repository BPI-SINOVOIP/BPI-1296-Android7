...
#ifdef RTK_PLATFORM
status_t MediaClock::getClkInfo(int64_t *pAnchorTimeMediaUs, int64_t *pAnchorTimeRealUs,
        int64_t *pMaxTimeMediaUs, int64_t *pStartingTimeMediaUs)
{
    *pAnchorTimeMediaUs =  mAnchorTimeMediaUs;
    *pAnchorTimeRealUs = mAnchorTimeRealUs;
    *pMaxTimeMediaUs = mMaxTimeMediaUs;
    *pStartingTimeMediaUs = mStartingTimeMediaUs;

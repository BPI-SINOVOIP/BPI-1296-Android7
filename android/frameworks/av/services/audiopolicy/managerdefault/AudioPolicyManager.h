...
//rtk begin
        ...
        bool isUSBConnected;
        bool isBTConnected;
        bool isHDMIRXConnected;
        int mHDMIRXvolume;      // set from HDMIRX app
        bool mAudioRedirect;
#ifdef USE_RTK_AOUT_UTIL
        bool isHDMIMuted;
        bool mBootComplete;
        long mHDMIRXAudioAOID;
        long mHDMIRXAudioAIID;
        long mHDMIRXAudioPIN;
        int mStreamVolumeIndex; //record stream volume index
#endif
        bool mRTKAudioActive;
        bool mForceSubmixInputSelection = false;
//rtk end

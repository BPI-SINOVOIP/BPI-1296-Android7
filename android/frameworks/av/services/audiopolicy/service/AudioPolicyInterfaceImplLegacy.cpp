...
status_t AudioPolicyService::setHDMIRXstate(bool state)
{
    ...
    return mpAudioPolicy->set_hdmirx_state(mpAudioPolicy, state);
}
...
status_t AudioPolicyService::setRTKAudioActive(bool state)
{
    ...
    return mpAudioPolicy->set_rtk_audio_active(mpAudioPolicy, state);
}
...
bool AudioPolicyService::isRTKAudioActive()
{
    ...
    Mutex::Autolock _l(mLock);
    return mpAudioPolicy->is_rtk_audio_active(mpAudioPolicy);
}
//rtk end

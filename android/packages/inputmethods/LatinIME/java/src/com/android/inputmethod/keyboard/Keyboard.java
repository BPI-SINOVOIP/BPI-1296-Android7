...
public class Keyboard {
    ...
    /* KEYCODE constatns copied from inputmethodservice/Keyboard.java */
    public static final int KEYCODE_SHIFT = -1;
    public static final int KEYCODE_MODE_CHANGE = -2;
    public static final int KEYCODE_SYMBOL = -3;  // KEYCODE_CANCEL
    public static final int KEYCODE_DONE = 10;  // -4;
    public static final int KEYCODE_DELETE = -5;
    public static final int KEYCODE_SETTINGS = -6;   // KEYCODE_ALT
    public static final int KEYCODE_EMOJI = -11;

...
public class A2dpMediaBrowserService extends MediaBrowserService {
    ...
    private BluetoothProfile mcloseAvrcpProfile = null;
    ...
    public void onDestroy() {
        Log.d(TAG, "onDestroy");
        mAdapter.closeProfileProxy(BluetoothProfile.AVRCP_CONTROLLER,mcloseAvrcpProfile);
        mcloseAvrcpProfile = null;
        mSession.release();

...
ifeq ("$(ADD_DEFINES)", "-DSUPPORT_FAST_MC_INTERPOLATION")
    DEFINES         += -DSUPPORT_FAST_MC_INTERPOLATION
endif
...
$(OBJDIR)/main_coda980_dec_test.o : sample/main_coda980_dec_test.c $(MAKEFILE)

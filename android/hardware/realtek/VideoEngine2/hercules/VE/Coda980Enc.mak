...
#
# ----------------------------------------------------------------------
.PHONY: TARGET LIBTHEORA LIBROIRC CREATE_DIR
...
#	make -C vpuapi/coda9/980_roi_rc_lib BUILD_CONFIGURATION=$(BUILD_CONFIGURATION) clean
	$(RM) $(OBJDIR)/$(ALLDEPS)
	$(RM) $(OBJDIR)/$(ALLOBJS)
	$(RM) $(TARGET)
...
#LIBROIRC: 
#	make -C vpuapi/coda9/980_roi_rc_lib BUILD_CONFIGURATION=$(BUILD_CONFIGURATION)


$(OBJDIR)/main_coda980_enc_test.o : sample/main_coda980_enc_test.c $(MAKEFILE)
...
$(OBJDIR)/wave5.o : vpuapi/wave/wave5.c $(MAKEFILE)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)

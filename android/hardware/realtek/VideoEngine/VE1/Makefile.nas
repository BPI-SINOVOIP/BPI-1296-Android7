...
VPATH= $(INTERMEDIATE_DIR):src:vdi:vdi/linux:vpuapi:vpuapi/coda9:vpuapi/wave/wave4:vpuapi/wave/common:vpuapi/wave/coda7q:theoraparser:theoraparser/src:sample/helper:
...
VPUAPI_SOURCES = mm.c vdi.c vdi_osal.c vpuapi.c vpuapifunc.c coda9.c wave4.c product.c
VPUAPI_SOURCES += vpuhelper.c common.c coda7q.c

VPUAPI_OBJECTNAMES=$(patsubst %.c,%.vpuo,$(patsubst %.cpp,%.vpuo,$(VPUAPI_SOURCES)))
VPUAPI_OBJECTPATHS=$(addprefix $(INTERMEDIATE_DIR)/,$(VPUAPI_OBJECTNAMES))

LOCAL_SHARED_LIBRARIES = -L$(DESTINATION_DIR) -Wl,--no-undefined -lpthread -lm -lion -lRTK_lib\
...
$(DESTINATION_DIR)/$(VPUAPI_RESULT): $(VPUAPI_OBJECTNAMES)
	...
	@echo ""
	$(CC) -shared $(LOCAL_SHARED_LIBRARIES) -s -o $@ $(VPUAPI_OBJECTPATHS)

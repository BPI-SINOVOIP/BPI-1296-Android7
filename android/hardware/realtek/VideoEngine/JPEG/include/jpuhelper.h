...
extern "C" {
    ...
    int LoadYuvImageHelperFormat( FILE *yuvFp,
                                  Uint8 *pYuv,
    ...
    int SaveYuvImageHelperFormat( FILE *yuvFp,
                                  Uint8 *pYuv,
                                  PhysicalAddress addrY,
                                  PhysicalAddress addrCb,
                                  PhysicalAddress addrCr,
    ...
    typedef enum { ARGB4444, RGB565, ARGB8888 } rgb_color_format;
    void jpu_yuv2rgb(int width, int height, yuv2rgb_color_format format, unsigned char *src, unsigned char *rgba, int chroma_reverse);

...
CFLAGS = -g -I./jpuapi -I./include $(DEFINES)
ARFLAGS = cru
LDFLAGS = -lpthread -lm 
LDFLAGS += -static
...
$(DESTINATION_DIR)/$(RESULT): $(OBJECTNAMES) $(JPUAPI_OBJECTNAMES)
	...
	@echo ""
	@$(CC) $(CFLAGS) $(SYSROOTFLAGS) $(OBJECTPATHS) $(JPUAPI_OBJECTPATHS) -o $@ $(LDFLAGS) -lc -lgcc_eh
...
$(DESTINATION_DIR)/$(JPUAPI_RESULT): $(JPUAPI_OBJECTNAMES)
	...
	@echo ""
	@$(CC) -shared -s -o  $@ $(JPUAPI_OBJECTPATHS)  -Wl,--no-undefined -lpthread

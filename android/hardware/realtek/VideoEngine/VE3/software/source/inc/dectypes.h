...
enum DecRet {
    ...
    DEC_SEQUENCE_CHANGE = 16,      /* RTK state for sequence change */
    DEC_NEED_MORE = 17,            /* RTK state for search first I frame */
    DEC_NEED_FLUSH = 18,           /* RTK state for buffer status confusion */

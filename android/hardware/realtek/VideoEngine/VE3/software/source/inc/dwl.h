...
#define VE3_ERROR(fmt, args...) LogMsg(1, fmt, ##args)
#ifdef _VE3_DEBUG
#define VE3_DEBUG(fmt, args...) LogMsg(0, fmt, ##args)
#else
#define VE3_DEBUG(fmt, args...) \
  do {                          \
...
#define DWL_CLIENT_TYPE_HEVC_DEC 12U
    ...
    void DWLResetHw(const void *instance, i32 *core_id);
    ...
    i32 DWLSetClockGate(i32 dec_fd, i32 enable);
    i32 DWLNotifyRelease(i32 dec_fd);

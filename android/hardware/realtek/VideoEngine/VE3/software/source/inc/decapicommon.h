...
struct DecHwConfig {
    ...
    u32 addr_64bit_support;    /* HW supports 64-bit addressing. */
    ...
    /* RTK Begin */
    u32 rtk_asic_revision;     /* RTK Private Asic revision */
    /* RTK End */
};
...
enum DecDownscaleStete {
    DEC_OUT_SCALE_IDLE = 0,
    DEC_OUT_SCALE_ENABLE,
    DEC_OUT_SCALE_DISABLE
};

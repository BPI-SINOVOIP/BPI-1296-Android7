...
enum {
    ...
    /*
     * this is for RTK to notice HWComposer it is Video Layer ..
     * please clear if you don't use it
     */
    HWC_HINT_RTK_SURFACEFLINGER2HAL_VIDEO_LAYER       = 0x01000000,
    HWC_HINT_RTK_SURFACEFLINGER2HAL_MEDIA_LAYER       = 0x02000000,
    HWC_HINT_RTK_SURFACEFLINGER2HAL_VIDEO_LAYER_EXT   = 0x04000000,

...
struct audio_policy {
    ...
    int (*set_hdmirx_state)(struct audio_policy *pol, bool state);

    int (*set_rtk_audio_active)(struct audio_policy *pol, bool state);

    bool (*is_rtk_audio_active)(struct audio_policy *pol);

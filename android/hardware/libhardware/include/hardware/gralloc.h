...
//[ RTK begin ]
    ...
    GRALLOC_USAGE_SECURE                = 0x08000000,
    GRALLOC_USAGE_HWC_HWOVERLAY         = 0x20000000, /* Didn't use this define for RTK platform. This value same as GRALLOC_USAGE_PRIVATE_1, it will cause gralloc module uses BT709 not BT601. */
    GRALLOC_USAGE_HDMIRX_PROTECTED      = 0x00400000,
//[ RTK end ]
#endif
...
//[ RTK begin ]
/*
 * Do not modify this struct! ( mali_gralloc_private_module_t )
 * Reference Mali gralloc module.
 */
#define MAX_ION_INFO_ALLOCS 2
typedef struct mali_gralloc_private_module_t {
	gralloc_module_t base;
    int (*GetPhyAddrs)(struct private_module_t const* module,
            buffer_handle_t handle,
            unsigned int auiPhyAddr[MAX_ION_INFO_ALLOCS]);
    int (*GetYUVData)(struct private_module_t const* module,
            buffer_handle_t handle,
            void * pYUVData);
    int (*SetPrivData)(struct private_module_t const* module,
            buffer_handle_t handle,
            void * pPrivData, unsigned int size);
    int (*GetPrivData)(struct private_module_t const* module,
            buffer_handle_t handle,
            void * pPrivData, unsigned int size);
    int (*Validate) (struct private_module_t const* module,
            buffer_handle_t handle);
    int (*GetPhyAddrs64)(struct private_module_t const* module,
            buffer_handle_t handle,
            unsigned long long auiPhyAddr[MAX_ION_INFO_ALLOCS]);
    int (*InitPrivData) (struct private_module_t const* module,
            buffer_handle_t handle,
            void * pPrivData, unsigned int size);
} mali_gralloc_private_module_t;
//[ RTK end ]
#endif

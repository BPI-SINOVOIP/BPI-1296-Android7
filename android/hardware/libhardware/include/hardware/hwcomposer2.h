...
typedef enum {
    ...
    HWC2_COMPOSITION_OVERLAY = 6,
    HWC2_COMPOSITION_SCALE = 7,
    HWC2_COMPOSITION_SCALE_EXT = 8,
} hwc2_composition_t;
...
static inline const char* getCompositionName(hwc2_composition_t composition) {
    switch (composition) {
        ...
        case HWC2_COMPOSITION_OVERLAY: return "Overlay";
        case HWC2_COMPOSITION_SCALE: return "Scale";
        case HWC2_COMPOSITION_SCALE_EXT: return "Scale_ext";
        default: return "Unknown";
    }
}
...
enum class Composition : int32_t {
    ...
    Overlay = HWC2_COMPOSITION_OVERLAY,
    Scale = HWC2_COMPOSITION_SCALE,
    Scale_ext = HWC2_COMPOSITION_SCALE_EXT,
};

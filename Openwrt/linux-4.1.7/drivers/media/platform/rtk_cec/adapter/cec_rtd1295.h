...
#ifndef __RTD1295_CEC_H__
#define __RTD1295_CEC_H__
...
typedef struct 
{
	...
	unsigned long  standby_config;//			: 0;
	unsigned char  standby_logical_addr;//		: 0xF;
	unsigned short standby_physical_addr;//	: 0xFFFF;
	unsigned char  standby_cec_version;//		: CEC_VERSION_1_4;
	unsigned long  standby_vendor_id;//		: 0x000000;
...
#define write_reg32(addr, val)   	iowrite32(val, (volatile unsigned int*)(addr))
#define read_reg32(addr)            ioread32((volatile unsigned int*)(addr))

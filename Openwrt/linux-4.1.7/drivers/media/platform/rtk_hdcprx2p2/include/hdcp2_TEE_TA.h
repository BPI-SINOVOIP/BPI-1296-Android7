...
#define TEE_HDCP_DEBUG(format, ...) printk("[TEE_HDCP_DBG] " format "\n", ## __VA_ARGS__)
#else
#define TEE_HDCP_DEBUG(format, ...) 
#endif

#define TEE_HDCP_ERROR(format, ...) printk(KERN_ERR "[TEE_HDCP_ERR] " format "\n", ## __VA_ARGS__)
#define TEE_HDCP_INFO(format, ...) printk(KERN_WARNING "[TEE_HDCP] " format "\n", ## __VA_ARGS__)

...
extern int venus_ir_setkeycode(unsigned int scancode, unsigned int new_keycode, unsigned int *p_old_keycode, unsigned long *keybit_addr);
extern int venus_ir_getkeycode(unsigned int scancode, unsigned int *p_keycode);

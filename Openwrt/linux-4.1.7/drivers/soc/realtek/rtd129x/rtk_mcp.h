...
#define  MCP_ST					(CP_REG_BASE + 0x1a0)
#define  MCP_ST1				(CP_REG_BASE + 0x1a4)
#define  MCP_PWM				(CP_REG_BASE + 0x1e0)
#define  MCP_KCTRL				(CP_REG_BASE + 0x900)
#define  MCP_KSTATUS				(CP_REG_BASE + 0x904)
...
#define GET_MCP_ST(y)			readl((volatile unsigned int*) (MCP_ST+y))
#define GET_MCP_ST1(y)			readl((volatile unsigned int*) (MCP_ST1+y))
#define GET_MCP_PWM(y)			readl((volatile unsigned int*) (MCP_PWM+y))
#define GET_MCP_KCTRL(y)		readl((volatile unsigned int*) (MCP_KCTRL+y))
#define GET_MCP_KSTATUS(y)		readl((volatile unsigned int*) (MCP_KSTATUS+y))

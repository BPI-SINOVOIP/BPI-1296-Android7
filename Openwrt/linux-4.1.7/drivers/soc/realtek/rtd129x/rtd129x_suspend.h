/*
 * rtd129x_suspend.h - power management driver
 *
...
#ifndef DRIVERS_SOC_REALTEK_RTD129X_RTD129X_SUSPEND_H_
#define DRIVERS_SOC_REALTEK_RTD129X_RTD129X_SUSPEND_H_
...
#define SUSPEND_ISO_GPIO_BASE                   101
#define SUSPEND_ISO_GPIO_SIZE                   35
...
#define GPIO_OUTPUT_CHANGE_EN_BITS              24
...
#define GPIO_OUTPUT_CHANGE_ACT_BITS             24
...
#define GPIO_OUTPUT_CHANGE_EN2_BITS				11
#define GPIO_OUTPUT_CHANGE_EN2_MASK(val)		SET_VAL(val, GPIO_OUTPUT_CHANGE_EN_BITS, GPIO_OUTPUT_CHANGE_EN_SHIFFT)
#define GPIO_OUTPUT_CHANGE_EN2_GET(reg)			GET_VAL(reg, GPIO_OUTPUT_CHANGE_EN_BITS, GPIO_OUTPUT_CHANGE_EN_SHIFFT)

#define GPIO_OUTPUT_CHANGE_ACT2_SHIFFT			0
#define GPIO_OUTPUT_CHANGE_ACT2_BITS			11
#define GPIO_OUTPUT_CHANGE_ACT2_MASK(val)		SET_VAL(val, GPIO_OUTPUT_CHANGE_ACT_BITS, GPIO_OUTPUT_CHANGE_ACT_SHIFFT)
#define GPIO_OUTPUT_CHANGE_ACT2_GET(reg)		GET_VAL(reg, GPIO_OUTPUT_CHANGE_ACT_BITS, GPIO_OUTPUT_CHANGE_ACT_SHIFFT)
...
#endif /* DRIVERS_SOC_REALTEK_RTD129X_RTD129X_SUSPEND_H_ */

...
struct dev_priv {
	...
	u32 link_event;
#endif				/* defined(CONFIG_RTD_1295_HWNAT) */
#if defined(RX_TASKLET) || defined(CONFIG_RTL_ETH_NAPI_GRO_SUPPORT)
...
#if defined(CONFIG_RTD_1295_HWNAT)
#define RTL_PS_LAN_P0_DEV_NAME RTL_DEV_NAME_NUM(RTL_PS_ETH_NAME, 1)
#define RTL_PS_WAN0_DEV_NAME RTL_DEV_NAME_NUM(RTL_PS_ETH_NAME, 0)
#else /* CONFIG_RTD_1295_HWNAT */

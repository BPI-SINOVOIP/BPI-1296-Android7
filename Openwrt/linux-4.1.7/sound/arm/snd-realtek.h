...
#define RTK_DMP_PLAYBACK_FORMATS (SNDRV_PCM_FMTBIT_S8 | SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S24_LE)
#define RTK_DMP_PLYABACK_RATES (SNDRV_PCM_RATE_8000_192000)
...
#define RTK_DEC_AO_BUFFER_SIZE          (6*1024)//(10*1024)

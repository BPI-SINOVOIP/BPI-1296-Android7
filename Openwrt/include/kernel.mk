...
ifeq ($(DUMP),1)
  ...
  LINUX_VERMAGIC:=$(if $(LINUX_VERMAGIC),$(LINUX_VERMAGIC),016f01d0f60e393615fac31c0ee07de4)
  ...
  ifeq ($(USE_LOCALVERSION),1)
    LINUX_UNAME_VERSION:=$(shell cat $(LINUX_DIR)/include/config/kernel.release 2> /dev/null)
  endif

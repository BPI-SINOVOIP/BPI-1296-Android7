...
$(eval $(call nf_add,IPT_CORE,CONFIG_NETFILTER_XT_TARGET_LOG, $(P_XT)nf_log_common, ge 3.18.21))
$(eval $(call nf_add,IPT_CORE,CONFIG_NETFILTER_XT_TARGET_LOG, $(P_V4)nf_log_ipv4, ge 3.18.21))
...
$(eval $(call nf_add,IPT_CORE,CONFIG_IP_NF_TARGET_REJECT, $(P_V4)nf_reject_ipv4, ge 3.18.21))
...
$(eval $(call nf_add,IPT_EXTRA,CONFIG_NETFILTER_XT_MATCH_IPVS, $(if $(NF_KMOD),$(P_XT)xt_ipvs,$(P_XT)ipt_ipvs)))
...
# android
$(eval $(call nf_add,IPT_ANDROID,CONFIG_IP6_NF_MATCH_RPFILTER,$(P_V6)ip6t_rpfilter))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_IPV6_ROUTE_INFO,))

$(eval $(call nf_add,IPT_ANDROID,CONFIG_IP_NF_MATCH_AH, $(P_V4)ipt_ah))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_IP_NF_MATCH_ECN,))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_IP_NF_MATCH_RPFILTER,$(P_V4)ipt_rpfilter))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_IP_NF_MATCH_TTL,))

$(eval $(call nf_add,IPT_ANDROID,CONFIG_IP_NF_TARGET_NETMAP,))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_IP_NF_TARGET_ECN,$(P_V4)ipt_ECN))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_IP_NF_TARGET_TTL,))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_IP_NF_SECURITY,$(P_V4)iptable_security))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_IP_NF_ARPTABLES,$(P_V4)arp_tables))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_IP_NF_ARPFILTER,$(P_V4)arptable_filter))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_IP_NF_ARP_MANGLE,$(P_V4)arpt_mangle))

$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_NETLINK_ACCT, $(P_XT)nfnetlink_acct))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_NETLINK_QUEUE, $(P_XT)nfnetlink_queue))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_NETLINK_LOG, $(P_XT)nfnetlink_log))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_NETLINK_QUEUE_CT, $(P_XT)nfnetlink_queue_ct))

$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_CONNMARK, $(P_XT)xt_connmark))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_POLICY, $(P_XT)xt_policy))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_PKTTYPE, $(P_XT)xt_pkttype))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_QTAGUID, $(P_XT)xt_qtaguid $(P_XT)xt_qtaguid_print))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_QUOTA, $(P_XT)xt_quota))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_QUOTA2, $(P_XT)xt_quota2))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_SOCKET, $(P_XT)xt_socket))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_CONNLIMIT, $(P_XT)xt_connlimit))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_HELPER, $(P_XT)xt_helper))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_CONNMARK,))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_ECN, $(P_XT)xt_ecn))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_HASHLIMIT, $(P_XT)xt_hashlimit))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_HL, $(P_XT)xt_hl))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_IPRANGE, $(P_XT)xt_iprange))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_LENGTH, $(P_XT)xt_length))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_MARK,))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_STATISTIC, $(P_XT)xt_statistic))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_STRING, $(P_XT)xt_string))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_TCPMSS, $(P_XT)xt_tcpmss))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_MATCH_U32, $(P_XT)xt_u32))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_TARGET_CLASSIFY, $(P_XT)xt_CLASSIFY))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_TARGET_CONNMARK,))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_TARGET_CT, $(P_XT)xt_CT))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_TARGET_CONNSECMARK, $(P_XT)xt_CONNSECMARK))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_TARGET_HL, $(P_XT)xt_HL))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_TARGET_HMARK, $(P_XT)xt_HMARK))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_TARGET_IDLETIMER, $(P_XT)xt_IDLETIMER))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_TARGET_MARK, $(P_XT)xt_MARK))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_TARGET_NETMAP, $(P_XT)xt_NETMAP))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_TARGET_NFLOG, $(P_XT)xt_NFLOG))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_TARGET_NFQUEUE, $(P_XT)xt_NFQUEUE))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_TARGET_TPROXY, $(P_XT)xt_TPROXY))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_TARGET_TRACE, $(P_XT)xt_TRACE))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NETFILTER_XT_TARGET_SECMARK, $(P_XT)xt_SECMARK))

$(eval $(call nf_add,IPT_ANDROID,CONFIG_NFT_CHAIN_ROUTE_IPV6, $(P_V6)nft_chain_route_ipv6))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NFT_CHAIN_NAT_IPV6, $(P_V6)nft_chain_nat_ipv6))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NFT_COUNTER, $(P_XT)nft_counter))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NFT_CT, $(P_XT)nft_ct))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NFT_EXTHDR, $(P_XT)nft_exthdr))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NFT_LIMIT, $(P_XT)nft_limit))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NFT_LOG, $(P_XT)nft_log))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NFT_MASQ, $(P_XT)nft_masq))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NFT_MASQ_IPV6, $(P_V6)nft_masq_ipv6))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NFT_NAT, $(P_XT)nft_nat))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NFT_QUEUE, $(P_XT)nft_queue))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NFT_REDIR, $(P_XT)nft_redir))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NFT_REDIR_IPV6, $(P_V6)nft_redir_ipv6, ge 3.19.0))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NFT_REJECT, $(P_XT)nft_reject))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NFT_REJECT_INET, $(P_XT)nft_reject_inet))

$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CONNTRACK_AMANDA, $(P_XT)nf_conntrack_amanda))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CONNTRACK_BROADCAST, $(P_XT)nf_conntrack_broadcast))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CONNTRACK_EVENTS, $(P_XT)nf_conntrack_ecache))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CONNTRACK_FTP, $(P_XT)nf_conntrack_ftp))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CONNTRACK_H323, $(P_XT)nf_conntrack_h323))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CONNTRACK_IRC, $(P_XT)nf_conntrack_irc))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CONNTRACK_NETBIOS_NS, $(P_XT)nf_conntrack_netbios_ns))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CONNTRACK_PPTP, $(P_XT)nf_conntrack_pptp))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CONNTRACK_PROC_COMPAT,))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CONNTRACK_SANE, $(P_XT)nf_conntrack_sane))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CONNTRACK_SECMARK, $(P_XT)nf_conntrack_secmark))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CONNTRACK_TFTP, $(P_XT)nf_conntrack_tftp))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CONNTRACK_TIMEOUT, $(P_XT)nf_conntrack_timeout))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CONNTRACK_TIMESTAMP, $(P_XT)nf_conntrack_timestamp))

$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CT_PROTO_DCCP, $(P_XT)nf_conntrack_proto_dccp))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CT_PROTO_GRE, $(P_XT)nf_conntrack_proto_gre))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CT_PROTO_SCTP, $(P_XT)nf_conntrack_proto_sctp))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CT_PROTO_UDPLITE, $(P_XT)nf_conntrack_proto_udplite))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CT_NETLINK, $(P_XT)nf_conntrack_netlink))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_CT_NETLINK_TIMEOUT, $(P_XT)nfnetlink_cttimeout))

$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_NAT_IPV6, $(P_V6)nf_nat_ipv6))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_NAT_MASQUERADE_IPV6, $(P_V6)nf_nat_masquerade_ipv6, ge 3.16.1))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_IP6_NF_NAT, $(P_V6)ip6table_nat))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_IP6_NF_TARGET_MASQUERADE, $(P_V6)ip6t_MASQUERADE))

$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_TABLES, $(P_XT)nf_tables))
$(eval $(call nf_add,IPT_ANDROID,CONFIG_NF_TABLES_INET, $(P_XT)nf_tables_inet))
...
$(eval $(call nf_add,IPT_IPV6,CONFIG_IP6_NF_TARGET_REJECT, $(P_V6)nf_reject_ipv6, ge 3.17.0))
...
$(eval $(if $(NF_KMOD),$(call nf_add,IPT_NAT6,CONFIG_IP6_NF_NAT, $(P_V6)nf_nat_masquerade_ipv6, ge 3.16.1),))
...
$(eval $(call nf_add,IPT_NAT,CONFIG_IP_NF_TARGET_MASQUERADE, $(P_V4)nf_nat_masquerade_ipv4, ge 3.16.1))
...
$(eval $(if $(NF_KMOD),$(call nf_add,NFT_CORE,CONFIG_NF_REJECT_IPV4, $(P_V4)nf_reject_ipv4, ge 3.17.0),))
$(eval $(if $(NF_KMOD),$(call nf_add,NFT_CORE,CONFIG_NF_REJECT_IPV6, $(P_V6)nf_reject_ipv6, ge 3.17.0),))
...
$(eval $(if $(NF_KMOD),$(call nf_add,NFT_CORE,CONFIG_NFT_REDIR_IPV4, $(P_V4)nft_redir_ipv4, ge 3.19.0),))
$(eval $(if $(NF_KMOD),$(call nf_add,NFT_CORE,CONFIG_NFT_REDIR_IPV6, $(P_V6)nft_redir_ipv6, ge 3.19.0),))

$(eval $(if $(NF_KMOD),$(call nf_add,NFT_NAT,CONFIG_NFT_NAT, $(P_XT)nft_nat),))
$(eval $(if $(NF_KMOD),$(call nf_add,NFT_NAT,CONFIG_NF_NAT_MASQUERADE_IPV4, $(P_V4)nf_nat_masquerade_ipv4, ge 3.16.1),))
$(eval $(if $(NF_KMOD),$(call nf_add,NFT_NAT,CONFIG_NF_NAT_MASQUERADE_IPV6, $(P_V6)nf_nat_masquerade_ipv6, ge 3.16.1),))

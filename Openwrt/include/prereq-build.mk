...
tar_test_payload := 1f8b080817841b5a0203746573742e746172002b492cd235d433b2d467a0\
1d300002735353106d686e6a00e61b9a9880692860303432373433363430\
3504aa33343201520aa60c7400a5c525894540a7a4172556e257975a544c\
c093208fc0e82102009635622400020000

$(eval $(call SetupHostCommand,tar, \
	Please install GNU 'tar' with sort option support(v1.28 and later), \
	gtar --version 2>&1 | grep GNU, \
	gnutar --version 2>&1 | grep GNU, \
	tar --version 2>&1 | grep GNU && \
	echo $(tar_test_payload) | xxd -r -ps | tar tzv --sort=name))

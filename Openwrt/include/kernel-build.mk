...
define BuildKernel
  ...
  prepare: $(STAMP_CONFIGURED)
	ARCH=$(LINUX_KARCH) CROSS_COMPILE=$(TARGET_CROSS) $(MAKE) -C $(LINUX_DIR) include/config/kernel.release
	$(MAKE) -C image prepare TARGET_BUILD=
  compile: $(LINUX_DIR)/.modules
	$(MAKE) -C image prepare compile TARGET_BUILD=
  ...
  install: $(LINUX_DIR)/.image
	$(MAKE) -C image prepare compile install TARGET_BUILD=

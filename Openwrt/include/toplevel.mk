...
FEED_PREPARED:=$(TOPDIR)/package/feeds/.prepared
FEED_LOCK:=$(TOPDIR)/package/.feeds.lock

$(FEED_PREPARED):
	@flock -n $(FEED_LOCK) sh -c "\
...
prepare-tmpinfo: $(FEED_PREPARED) FORCE
	...
	$(_SINGLE)$(NO_TRACE_MAKE) -j1 -r -s -f include/scan.mk SCAN_TARGET="targetinfo" SCAN_DIR="target/linux" SCAN_NAME="target" SCAN_DEPS="profiles/*.mk */target.mk $(TOPDIR)/include/kernel*.mk $(TOPDIR)/include/target.mk" SCAN_DEPTH=2 SCAN_EXTRA="" SCAN_MAKEOPTS="TARGET_BUILD=1"

...
extern CWThreadMutex gWTPsMutex;
		/* TODO: babylon: gWTPsMutex here and in CWACipc_with_ac_hostapd() is to lock single entry in gWTPs[]. 
		 * 					it would be better to use other mutex for this purpose. we should modify it in the future.
		 */
#endif		

...
/*  *******************___TYPES___*******************  */
#define MAX_WAIT_SEC_AC_MULTI_HOMED_SOCK 5 
		// Babylon: use 5 sec to wait all the WTP sockets, avoid blocking for a too long period.
...
CWBool CWNetworkUnsafeMultiHomed(CWMultiHomedSocket *sockPtr, void (*CWManageIncomingPacket) (CWSocket, unsigned char *, int, int, CWNetworkLev4Address*,CWBool), CWBool peekRead);

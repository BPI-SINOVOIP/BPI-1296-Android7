...
define KernelPackage/ipt-conntrack
  ...
  $(call AddDepends/ipt,+!LINUX_3_10:kmod-nf-conntrack)
endef
...
IPSET_MODULES:= \
	...
	$(if $(call kernel_patchver_ge,3.18),ipset/ip_set_hash_ipmark) \
	ipset/ip_set_hash_ipport \
	ipset/ip_set_hash_ipportip \
	ipset/ip_set_hash_ipportnet \
	$(if $(call kernel_patchver_ge,3.18),ipset/ip_set_hash_mac) \
	$(if $(call kernel_patchver_ge,3.18),ipset/ip_set_hash_netportnet) \
	ipset/ip_set_hash_net \
	$(if $(call kernel_patchver_ge,3.18),ipset/ip_set_hash_netnet) \
...
define KernelPackage/nf-builtin
  SUBMENU:=$(NF_MENU)
  TITLE:=Netfilter Builtin Modules
  KCONFIG:= \
	$(addsuffix =y,$(KCONFIG_NF_IPT)) \
	$(addsuffix =y,$(KCONFIG_NF_IPT6)) \
	$(addsuffix =y,$(KCONFIG_NF_CONNTRACK)) \
	$(addsuffix =y,$(KCONFIG_NF_CONNTRACK6)) \
	$(addsuffix =y,$(KCONFIG_NF_NAT)) \
	$(addsuffix =y,$(KCONFIG_IPT_CORE)) \
	$(addsuffix =y,$(KCONFIG_IPT_CONNTRACK)) \
	$(addsuffix =y,$(KCONFIG_IPT_IPV6)) \
	$(addsuffix =y,$(KCONFIG_IPT_NAT))
  FILES:=
  AUTOLOAD:=
  DEPENDS:=@TARGET_rtd1295
endef

define KernelPackage/nf-builtin/description
  This package provides netfiler builtin modules feature
endef
$(eval $(call KernelPackage,nf-builtin))
